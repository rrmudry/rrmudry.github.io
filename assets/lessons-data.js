const lessonsData = [
  ...
  },
  {
    ...
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "A car cruises down the highway in a straight line at a steady speed of 65 mph. Is the net force acting on the car forward, backward, or zero?",
      "explanation": "The net force is zero! Because the car travels at constant velocity, its acceleration is zero (a = 0), which means all forward and resistive forces are balanced.",
      "defaultDuration": 3
    }
  },
  {
  ...
  },
  {
    ...
    "date": "2026-09-11",
    "unit": 2,
    "title": "Free Fall & Earth's Gravitational Acceleration",
    "topic": "Free Fall Kinematics & Air Resistance Boundaries (g = 9.8 m/s²)",
    "dok": 2,
    "type": "Activity",
    "semester": 1,
    "isFeatured": true,
    "summary": "Investigate free fall near Earth's surface, explore Galileo's insight that mass does not change fall rate in a vacuum, and analyze air drag terminal velocity.",
    "activity": "Drop-Sensor Inquiry & Apollo Moon Video Analysis: Students drop solid steel marbles vs light plastic spheres from 1.0m and 2.0m heights to measure drop times. Students analyze Apollo 15 footage of the hammer and feather dropped on the Moon to prove gravitational equivalence.",
    "essentialQuestion": "Why do heavy and light objects fall at identical rates in the absence of air resistance?",
    "standards": [
      "HS-PS2-1"
    ],
    "wicor": {
      "Writing": "Explaining why air resistance causes a flat paper to fall slower than a crumpled ball of identical mass.",
      "Inquiry": "Evaluating why our daily experience fools us into thinking heavy objects fall faster.",
      "Collaboration": "Working in teams to film slow-motion drop tests and calculate empirical g values.",
      "Organization": "Tabulating freefall drop distances using the formula Δy = ½ · g · t².",
      "Reading": "Analyzing historical accounts of Galileo's inclined plane and tower thought experiments."
    },
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "If you drop an elephant and a golf ball at the exact same instant from a tall cliff on the Moon (where there is no air), which lands first?",
      "explanation": "They land at the exact same time! In the absence of air resistance, all objects accelerate at the exact same rate regardless of mass.",
      "defaultDuration": 3
    },
    "links": {
      "Skydiving Simulation": "skydiving-game/index.html"
    }
  },
  {
    "day": 9,
    ...
    "topic": "Quantitative Incline Acceleration Investigation",
    "dok": 3,
    "type": "Lab",
    "semester": 1,
    "isFeatured": true,
    "summary": "Inquiry lab investigating how ramp elevation angle affects the acceleration and final velocity of rolling spheres down tracks.",
    "activity": "Students set up grooved incline ramps at 5°, 10°, and 15° angles. Using stopwatch intervals or photogate checkpoints, students record split times at multiple distances, plot velocity vs time, calculate acceleration slopes, and determine how ramp steepness governs acceleration.",
    "essentialQuestion": "How does ramp inclination quantitatively govern the rate of acceleration down an incline?",
    "standards": [
      "HS-PS2-1",
      "HS-ETS1-2"
    ],
    "wicor": {
      "Writing": "Writing an evidence-based lab report summarizing the correlation between ramp angle and acceleration.",
      "Inquiry": "Formulating hypotheses on how doubling track angle impacts final rollout velocity.",
      "Collaboration": "Dividing duties: angle surveyor, release coordinator, gate timer, and data logger.",
      "Organization": "Plotting multi-angle trials on a single coordinate graph to visually compare slope steepness.",
      "Reading": "Reading angle protractors and photogate sensor instructions accurately."
    },
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "When a marble rolls down a frictionless ramp, does its speed remain constant, or does it accelerate? How do you know?",
      "explanation": "It accelerates. A component of gravity pulls it forward continuously down the incline, causing it to cover greater distances in each subsequent second.",
      "defaultDuration": 3
    }
  },
  {
    ...
    "date": "2026-09-09",
    "unit": 2,
    "title": "Velocity vs. Time (v-t) Graphs: Slope & Area",
    "topic": "Graphing Acceleration & Area Under the Curve (Area = Δx)",
    "dok": 3,
    "type": "Activity",
    "semester": 1,
    "isFeatured": true,
    "summary": "Connect constant velocity (flat v-t line) with uniform acceleration (sloped v-t line), and discover that the area under a v-t graph yields displacement.",
    "activity": "Graph Matching & Area Challenge: Students work in pairs to match position-time curves with corresponding velocity-time graphs. Teams compute the geometric area (rectangles and triangles) beneath v-t line segments to determine total displacement.",
    "essentialQuestion": "How can the geometric area under a velocity-time graph reveal the total distance an object moved?",
    "standards": [
      "HS-PS2-1"
    ],
    "wicor": {
      "Writing": "Writing step-by-step mathematical proofs showing how geometric area calculates displacement.",
      "Inquiry": "Deducing why the slope of a velocity-time graph represents acceleration.",
      "Collaboration": "Pair-matching dual graph sets and reconciling disagreements on curve shapes.",
      "Organization": "Color-coding graph features: blue for slope (acceleration), green for area (displacement).",
      "Reading": "Translating multi-part velocity graphs into verbal motion stories."
    },
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "If an object travels at a constant velocity of 6 m/s for 5 seconds, what is the geometric shape of its velocity-time graph, and what is its displacement?",
      "explanation": "The v-t graph is a horizontal line at 6 m/s forming a rectangle with height 6 and base 5. The area is 6 m/s · 5 s = 30 meters displacement.",
      "defaultDuration": 3
    }
  },
  {
    ...
    "date": "2026-09-08",
    "unit": 2,
    "title": "Decoding Acceleration: When Velocity Changes",
    "topic": "Definition of Acceleration (a = Δv / Δt) & Metric Units (m/s²)",
    "dok": 2,
    "type": "Direct Instruction",
    "semester": 1,
    "isFeatured": true,
    "summary": "Define acceleration as the rate of change of velocity, break down the units of m/s², and analyze the three distinct physical ways to accelerate.",
    "activity": "Three Ways to Accelerate Video Telemetry Sprint: Students analyze automotive telemetry clips (gas pedal = speeding up, brake pedal = slowing down, steering wheel = changing direction). Students calculate acceleration rates from changing velocity readings over time.",
    "essentialQuestion": "Why is a vehicle turning a corner at constant speed still considered accelerating in physics?",
    "standards": [
      "HS-PS2-1"
    ],
    "wicor": {
      "Writing": "Defining why m/s² represents '(meters per second) gained every second'.",
      "Inquiry": "Dissecting real-world car test track data to calculate braking vs launching acceleration rates.",
      "Collaboration": "Partner problem-solving calculating positive and negative acceleration.",
      "Organization": "Constructing formula breakdown cards: a = (v_final - v_initial) / Δt.",
      "Reading": "Reading technical automobile specifications (e.g. 0 to 60 mph times) and converting to SI units."
    },
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "A car sitting at a red light steps on the gas and reaches 20 m/s in 4.0 seconds. What is the car's average acceleration?",
      "explanation": "Acceleration is a = (v_final - v_initial) / t = (20 m/s - 0 m/s) / 4.0 s = 5.0 m/s².",
      "defaultDuration": 3
    },
    "links": {
  ...
  },
  {
    ...
    "date": "2026-09-07",
    "unit": 2,
    "title": "Direction Matters: Vector Velocity & Sign Conventions",
    "topic": "Scalar Speed vs. Directional Vector Velocity (v = Δx / Δt)",
    "dok": 2,
    "type": "Practice",
    "semester": 1,
    "isFeatured": true,
    "summary": "Formalize vector velocity, explore sign conventions (+/- directions), and demonstrate why average velocity can be zero during a closed round trip.",
    "activity": "Vector Number-Line Simulation: Students use PhET 'The Moving Man' to model directional motion. They recreate motion graphs by controlling an avatar's forward and backward steps, proving why a negative slope represents returning motion and why round-trip velocity is zero.",
    "essentialQuestion": "Why is directional vector orientation essential for distinguishing return trips from continuous forward travel?",
    "standards": [
      "HS-PS2-1"
    ],
    "wicor": {
      "Writing": "Writing concise justifications for when velocity is positive, negative, or zero.",
      "Inquiry": "Experimenting with simulated velocity vectors to observe real-time vector arrows.",
      "Collaboration": "Pairs challenging each other with 'Motion Charades'—one acts out the motion, the other graphs the vector.",
      "Organization": "Creating a side-by-side comparison chart: Scalars (Speed, Distance) vs Vectors (Velocity, Displacement).",
      "Reading": "Interpreting vector arrows and sign indicators in physics problem statements."
    },
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "Can an object have a high speed while simultaneously having an average velocity of zero? Explain your reasoning.",
      "explanation": "Yes. If a car drives 100 miles around a circular race track at 100 mph and returns to the start, its average speed is 100 mph, but its displacement is 0, making its average velocity 0 m/s.",
      "defaultDuration": 3
    },
    "links": {
  ...
  },
  {
    ...
    "date": "2026-09-04",
    "unit": 2,
    "title": "Graphing Motion: Position vs. Time (x-t) Slopes",
    "topic": "Coordinate Graphing & Slope Interpretation (m = Δx / Δt)",
    "dok": 2,
    "type": "Activity",
    "semester": 1,
    "isFeatured": true,
    "summary": "Translate tumble buggy lab data into position vs. time graphs and prove that coordinate slope directly equals physical speed.",
    "activity": "Interactive Graphing Workshop: Students use graph paper and the digital Distance vs Time App to plot position-time data, draw best-fit trendlines, calculate coordinate slope (m = Δy / Δx = Δx / Δt), compare steep lines (fast) vs shallow lines (slow), and decode horizontal lines (at rest).",
    "essentialQuestion": "How does the geometric slope of a position-time graph directly encode physical speed?",
    "standards": [
      "HS-PS2-1"
    ],
    "wicor": {
      "Writing": "Writing narrative explanations describing the physical journey represented by each line segment.",
      "Inquiry": "Investigating how line steepness changes when an object speeds up or slows down.",
      "Collaboration": "Peer-checking coordinate slope calculations (rise over run).",
      "Organization": "Properly labeling graph axes with variable names, symbols, and metric units [Position (m) vs Time (s)].",
      "Reading": "Decoding graphic representations of multi-segment journeys."
    },
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "On a position-time graph, what does a completely flat, horizontal line indicate about the object's motion?",
      "explanation": "A flat, horizontal line means position is not changing over time (Δx = 0), so velocity is zero—the object is stationary (at rest).",
      "defaultDuration": 3
    },
    "links": {
  ...
  },
  {
    ...
    "topic": "Multi-Interval Kinematic Data Collection (Tumble Buggy Lab)",
    "dok": 2,
    "type": "Lab",
    "semester": 1,
    "isFeatured": true,
    "summary": "Empirical inquiry using motorized constant-speed tumble buggies to record position stamps every 2 seconds and verify uniform motion.",
    "activity": "Students release battery-operated motorized cars down meter tracks, drop beanbag markers every 2 seconds on audible cues, measure cumulative positions, record coordinate pairs in tables, and test whether displacement increments remain constant across time intervals.",
    "essentialQuestion": "How can multi-stage empirical data reveal whether an object travels with truly uniform motion?",
    "standards": [
      "HS-PS2-1",
      "HS-ETS1-2"
    ],
    "wicor": {
      ...
      "Organization": "Constructing clean position-time data tables ready for graphing.",
      "Reading": "Following multi-step laboratory protocols and safety guidelines."
    },
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "If a toy car moves at a steady, constant speed of 0.5 meters per second, how far will it travel in 6 seconds?",
      "explanation": "Using d = v · t: distance = 0.5 m/s · 6 s = 3.0 meters.",
      "defaultDuration": 3
    }
  },
  {
  ...
  },
  {
    ...
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "Why must every map and physics coordinate system start with an agreed-upon origin or reference point (0, 0)?",
      "explanation": "Without a fixed reference point, you cannot quantify position, distance, or change in position. All motion is relative to the chosen reference point.",
      "defaultDuration": 3
    },
    "links": {
      "Fantasy Map Slides": "https://orangeusdorg-my.sharepoint.com/:p:/g/personal/rmudry_orangeusd_org/IQDTeHashMmgSoeLVDHY5TwQAbynyLTufaGMoMjm5APx0Hw?e=nwclwC",
    ...
    "bellRinger": {
      ...
      "connectionsData": {
        "categories": [
          {
            "name": "SI Base Units",
            "words": ["Meter", "Kilogram", "Second", "Kelvin"]
          },
          {
            "name": "Metric Prefixes",
            "words": ["Kilo-", "Centi-", "Milli-", "Micro-"]
          },
          {
            "name": "Customary Units",
            "words": ["Inch", "Mile", "Pound", "Gallon"]
          },
          {
            "name": "Conversion Values",
            "words": ["2.54", "1000", "1.609", "5280"]
          }
        ]
      }
    }
