    ...
    "bellRinger": {
      ...
      "steps": [
        ...
        },
        {
          "stepId": "step_3",
          "type": "cer",
          "title": "Part 3: Scientific Argumentation (CER)",
          "prompt": "A student argues: 'If the net force is zero, the train cannot be moving and must immediately come to a complete stop.' Construct a Claim-Evidence-Reasoning response resolving this common physics misconception.",
          "scaffold": {
            "claimPlaceholder": "State whether zero net force requires an object to be at rest...",
            "evidencePlaceholder": "Cite Newton's First Law (Law of Inertia) and experimental evidence regarding constant velocity motion...",
            "reasoningPlaceholder": "Explain why net force causes changes in motion (acceleration), not motion itself..."
          }
        }
      ],
    ...
    "bellRinger": {
      ...
      "steps": [
        ...
        },
        {
          "stepId": "step_3",
          "type": "cer",
          "title": "Part 3: Comparative Argumentation (CER)",
          "prompt": "Determine which vehicle arrives first at the clinic and by how many seconds. Construct a Claim-Evidence-Reasoning response justifying the optimal dispatch choice.",
          "scaffold": {
            "claimPlaceholder": "Identify which vehicle arrives first and state the time difference...",
            "evidencePlaceholder": "Provide calculated times for both Drone Alpha (600 m / 25 m/s) and Rover Beta (720 m / 24 m/s)...",
            "reasoningPlaceholder": "Explain how path distance differences offset higher ground speed to determine the winner..."
          }
        }
      ],
    ...
    "bellRinger": {
      ...
      "steps": [
        ...
        },
        {
          ...
          "type": "cer",
          "title": "Part 3: Scientific Argumentation (CER)",
          "prompt": "If the buggy's battery began dying during the run causing it to slow down, explain what visual change would occur to the slope of the position-time graph.",
          "scaffold": {
            "claimPlaceholder": "State how the shape of the graph would change as speed decreases over time...",
            "evidencePlaceholder": "Reference the relationship between instantaneous slope (steepness) and velocity...",
            "reasoningPlaceholder": "Explain why a decreasing velocity produces a downward curving parabola rather than a straight line..."
          }
        }
      ],
    ...
    "bellRinger": {
      ...
      "steps": [
        ...
        },
        {
          ...
          "type": "cer",
          "title": "Part 3: Scientific Argumentation (CER)",
          "prompt": "Evaluate the statement: 'If the rover completes its geological sampling and drives directly back to the landing site, its total distance traveled is 0 meters and its net displacement is 0 meters.' Construct a CER response.",
          "scaffold": {
            "claimPlaceholder": "State whether the claim regarding distance and displacement for a round trip is correct, partially correct, or incorrect...",
            "evidencePlaceholder": "Provide the numerical values for total odometer distance vs initial and final coordinates...",
            "reasoningPlaceholder": "Explain using physics principles why round-trip displacement equals zero while scalar distance accumulates..."
          }
        }
      ],
    ...
    "bellRinger": {
      ...
      "steps": [
        ...
        },
        {
          ...
          "type": "cer",
          "title": "Part 3: Scientific Argumentation (CER)",
          "prompt": "A trainee claims: 'If Base Camp relocates 10 km South, the actual physical wreckage of the drone moves.' Construct a Claim-Evidence-Reasoning response evaluating this claim.",
          "scaffold": {
            "claimPlaceholder": "State whether moving the reference frame origin alters the physical position of the object...",
            "evidencePlaceholder": "Cite evidence from coordinate systems, origins, and geographic landmarks...",
            "reasoningPlaceholder": "Apply scientific reasoning connecting reference points to coordinate values versus physical reality..."
          }
        }
      ],
