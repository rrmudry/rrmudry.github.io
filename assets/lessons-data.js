const lessonsData = [
  ...
  },
  {
    ...
    "bellRinger": {
      "type": "cast_challenge",
      "title": "Shaded Area Under the Velocity-Time Graph",
      "defaultDuration": 4,
      "standards": {
        "dci": "HS-PS2.A: Forces & Motion",
        "sep": "SEP-5: Using Mathematics & Computational Thinking",
      ...
      "phenomenon": {
        "title": "Electric Dragster Acceleration Run",
        "description": "An electric sports car accelerates along a test track from an initial cruising speed of v₀ = +10.0 m/s to a final speed of v<sub>f</sub> = +30.0 m/s over an elapsed time of t = 4.0 seconds. Engineers compute track displacement from the velocity-time graph.",
        "stimulus": {
          "type": "data_table",
          "title": "Dragster 4.0-Second Run Telemetry",
          "headers": [
            "Parameter",
            "Symbol",
            "Value",
          ...
          "rows": [
            {
              ...
              "col_1": "v₀",
              "col_2": "+10.0 m/s",
              "col_3": "Height of bottom rectangle"
            },
            {
              "col_0": "Final Velocity",
              "col_1": "v<sub>f</sub>",
              "col_2": "+30.0 m/s",
              "col_3": "Top peak height of trapezoid"
            },
            {
              "col_0": "Elapsed Time",
              "col_1": "t",
              "col_2": "4.0 s",
              "col_3": "Horizontal width of base"
            },
            {
              "col_0": "Velocity Change",
              "col_1": "Δv",
              "col_2": "+20.0 m/s",
              "col_3": "Height of upper triangle (v<sub>f</sub> - v₀)"
            }
          ]
        }
      },
      "steps": [
        {
          "stepId": "step_1",
          "type": "cloze_dropdown",
          "title": "Part 1: Partitioning the v-t Area into Shapes",
          "prompt": "Partition the trapezoidal area under the v-t graph between t = 0 and t = 4.0 s into two geometric shapes:",
          "text": "The lower shape under v = 10.0 m/s is a rectangle with area [blank1]. The upper shape above v = 10.0 m/s is a triangle with area [blank2].",
          "blanks": {
            "blank1": {
              "correct": "Rectangle Area = 10.0 m/s · 4.0 s = 40.0 m",
              "options": [
                "Rectangle Area = 10.0 m/s · 4.0 s = 40.0 m",
                "Rectangle Area = 30.0 m/s · 4.0 s = 120.0 m",
                "Rectangle Area = 5.0 m/s · 4.0 s = 20.0 m"
              ]
            },
            "blank2": {
              "correct": "Triangle Area = ½ · (4.0 s) · (20.0 m/s) = 40.0 m",
              "options": [
                "Triangle Area = ½ · (4.0 s) · (20.0 m/s) = 40.0 m",
                "Triangle Area = (4.0 s) · (20.0 m/s) = 80.0 m",
                "Triangle Area = ½ · (4.0 s) · (30.0 m/s) = 60.0 m"
              ]
            }
          }
        },
        {
          "stepId": "step_2",
          "type": "data_calculation",
          "title": "Part 2: Calculating Total Displacement",
          "prompt": "Sum the rectangle and triangle areas (40.0 m + 40.0 m) to calculate the total displacement in meters (Δx).",
          "inputLabel": "Total Displacement",
          "unit": "m",
          "targetValue": 80,
          "tolerance": 0.1,
          "hint": "Total displacement Δx = Area<sub>rect</sub> + Area<sub>tri</sub> = 40.0 m + 40.0 m = 80.0 meters."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
          "title": "Part 3: Average Velocity Verification with AI Mentor",
          "prompt": "Discuss your reasoning with the AI Physics Mentor: Verify the total displacement using the average velocity formula Δx = ½(v₀ + v<sub>f</sub>) · t and explain why both methods give the exact same answer.",
          "openingPrompt": "You found that the dragster travels 80.0 meters! Now try calculating average velocity: v<sub>avg</sub> = ½(10 + 30) = 20 m/s. What is v<sub>avg</sub> · t? Why do both the geometric area method and the average velocity method give the exact same result?",
          "minTurns": 1
        }
      ],
      "teacherKey": "Step 1: Rectangle Area = 10.0 m/s · 4.0 s = 40.0 m, Triangle Area = ½ · (4.0 s) · (20.0 m/s) = 40.0 m. Step 2: 80.0 m (40.0 + 40.0). Step 3: Claim: The average velocity method and the geometric area method yield the exact same displacement of 80.0 meters. Evidence: v<sub>avg</sub> = ½(v₀ + v<sub>f</sub>) = ½(10.0 + 30.0) = 20.0 m/s. Then Δx = v<sub>avg</sub> · t = 20.0 m/s · 4.0 s = 80.0 m. Reasoning: On a graph with a linear slope (constant acceleration), the average velocity is located exactly halfway between the initial and final speeds. Multiplying this average velocity by time transforms the trapezoid into an equivalent rectangle with the exact same total area."
    },
    "assignments": [
      {
