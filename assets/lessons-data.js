...
const lessonsData = [
  ...
  },
  {
    ...
    details: "Lecture and practice on reading PV diagrams. Calculating the area under the curve to find work (W = PΔV) and transitioning towards heat engines.",
    type: "Activity",
    dok: 3,
    semester: 2,
    isFeatured: true
  },
  {
    ...
    details: "Students use a syringe and pressure sensor (or simulation) to verify Boyle's Law and Charles's Law, connecting macroscopic properties to internal energy.",
    type: "Lab",
    dok: 3,
    semester: 2,
    isFeatured: true
