const lessonsData = [
  ...
  },
  {
    ...
    "bellRinger": {
      ...
      "phenomenon": {
        ...
        "type": "text",
        "text": "A high-speed electric passenger train cruises along a straight, horizontal track at a constant velocity of 40 m/s (approx. 90 mph). The electric locomotive drive motors exert 18,000 N of forward horizontal thrust against the rails. Meanwhile, aerodynamic air resistance and wheel track friction exert opposing backward forces."
      },
      "steps": [
        {
          "stepId": "step_1",
          ...
          "text": "Because the passenger train travels at a constant velocity, its acceleration is [blank1]. According to Newton's First Law, when acceleration is zero, the net force ΣF acting on the system must be [blank2]. The forward motor thrust and total backward resistive forces are therefore [blank3].",
          "blanks": {
            "blank1": {
              "correct": "0 m/s²",
              "options": [
            ...
            "blank2": {
              "correct": "equal to 0 N",
              "options": [
                "equal to 0 N",
                "greater than 0 N forward",
                "equal to the train's mass"
              ]
            },
            "blank3": {
        ...
        },
        {
          ...
          "title": "Part 2: Resistive Force Quantification",
          "prompt": "Given that the forward motor force is 18,000 N and the train maintains constant velocity (F_net = 0), calculate the total resistive drag and friction force acting on the train in Newtons.",
        ...
        },
        {
          ...
          "prompt": "Discuss your thinking with the AI Physics Mentor. Defend your resistive force calculation and explain why zero net force does NOT mean the train must be stopped.",
          "openingMessage": "You found that the resistive forces equal 18,000 N! A student claims that because the net force is zero, the train cannot be moving and must be stopped. Why are they wrong? Defend dynamic equilibrium!",
          "quickChips": [
            "Zero net force means constant velocity, not zero speed",
            "Net forces cause acceleration, not motion itself",
            "What happens if motor thrust drops to 15,000 N?"
          ]
        }
      ],
      "teacherKey": "Step 1: 0 m/s², equal to 0 N, balanced (equal and opposite). Step 2: 18000 N. Step 3: Claim: False. An object with zero net force can be moving at a constant velocity in dynamic equilibrium. Evidence: Newton's First Law states an object in motion remains in motion with constant speed in a straight line unless acted upon by an unbalanced net force. Reasoning: Forces do not cause motion; unbalanced net forces cause changes in velocity (acceleration). Because forward thrust balances backward friction, no acceleration occurs, allowing the train to continue at 40 m/s indefinitely."
    }
  },
  {
    "day": 14,
  ...
  },
  {
    ...
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "Look at these three problems: (A) Find how far a car goes in 5s at 20 m/s; (B) Find how fast a runner is if they go 100m in 10s; (C) Find how long it takes sound to travel 680m at 340 m/s. For each, state which formula from the triangle you use!",
  ...
  },
  {
    ...
    "bellRinger": {
      ...
      "phenomenon": {
        ...
        "type": "text",
        "text": "An emergency medical depot must deliver critical serum to a clinic 600 meters away. Dispatch evaluates two transport options: Aerial Drone Alpha flies a direct 600-meter straight flight path at a steady speed of 25 m/s. Ground Rover Beta travels an indirect 720-meter paved road route at a steady speed of 24 m/s."
      },
      "steps": [
        {
          "stepId": "step_1",
          "type": "cloze_dropdown",
          "title": "Part 1: Algebraic Proportions in Kinematics",
          "prompt": "Analyze the speed equation formula relationships:",
          "text": "Rearranging the constant speed equation v = d / t to solve for travel time yields [blank1]. This means that travel time is [blank2] proportional to travel distance and [blank3] proportional to speed.",
          "blanks": {
            "blank1": {
              "correct": "t = d / v",
              "options": [
        ...
        },
        {
          ...
          "prompt": "Calculate the exact transit time in seconds required for Aerial Drone Alpha to complete its 600-meter flight at 25 m/s.",
          "inputLabel": "Transit Time",
          "unit": "s",
          "targetValue": 24,
          "tolerance": 0.5,
          "hint": "Using t = d / v: time = 600 m / (25 m/s)."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
          "title": "Part 3: Defend Your Thinking (AI Physics Mentor)",
          "prompt": "Discuss your thinking with the AI Physics Mentor. Defend your travel time calculation and explain why the straight flight path arrives first.",
          "openingMessage": "You calculated 24 seconds for Drone Alpha! Which vehicle gets to the clinic first, and why did the vehicle with the straight path win even though the ground rover drove at a similar speed?",
          "quickChips": [
            "Drone Alpha wins because its path is shorter (600 m vs 720 m)",
            "Rover Beta took 30 seconds due to extra road distance",
            "How fast would the rover need to drive to arrive first?"
          ]
        }
      ],
      "teacherKey": "Step 1: t = d / v, directly, inversely. Step 2: 24.0 seconds. Step 3: Claim: Aerial Drone Alpha arrives first by 6.0 seconds. Evidence: Drone Alpha time = 600 m / 25 m/s = 24.0 s; Rover Beta time = 720 m / 24 m/s = 30.0 s (30.0 s - 24.0 s = 6.0 s). Reasoning: Even though Rover Beta travels almost as fast as the drone, the road route adds 120 m of extra distance, requiring 6 additional seconds to arrive."
    },
    "assignments": [
      {
  ...
  },
  {
    ...
    "bellRinger": {
      ...
      "phenomenon": {
        "title": "Laboratory Tumble Buggy Ultrasonic Sensor Run",
        "type": "graph",
        "text": "An ultrasonic motion detector tracks a battery-powered motorized tumble buggy rolling along a meter track. Position coordinates are sampled at regular 2.0-second intervals as shown in the interactive scatter plot below.",
        "graphData": {
      ...
      "steps": [
        {
          ...
          "prompt": "Analyze the pattern of the data points and trendline on the position-time graph:",
          "text": "The position vs time graph displays a [blank1] relationship. On a position-time graph, the slope of the line represents the object's [blank2]. Because the slope remains constant throughout the run, the buggy experiences [blank3].",
          "blanks": {
            "blank1": {
        ...
        },
        {
          "stepId": "step_2",
          "type": "data_calculation",
          "title": "Part 2: Slope & Velocity Determination",
          "prompt": "Calculate the velocity of the tumble buggy in m/s using data coordinates from t = 2.0 s (x = 0.8 m) to t = 10.0 s (x = 4.0 m).",
          "inputLabel": "Calculated Velocity",
          "unit": "m/s",
          "targetValue": 0.4,
          "tolerance": 0.02,
          "hint": "Slope = Δx / Δt = (4.0 m - 0.8 m) / (10.0 s - 2.0 s) = 3.2 m / 8.0 s."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
          "title": "Part 3: Defend Your Thinking (AI Physics Mentor)",
          "prompt": "Discuss your thinking with the AI Physics Mentor. Defend your calculated velocity and explain what happens to the slope of a position-time graph if the buggy slows down.",
          "openingMessage": "I see you calculated a slope of 0.4 m/s. Why does the slope of a position-time graph represent velocity, and what would happen to the line if the buggy started slowing down?",
          "quickChips": [
            "Slope is Δx / Δt which equals velocity",
            "The line would curve and become flatter over time",
            "What if the buggy was rolling backwards?"
          ]
        }
      ],
      "teacherKey": "Step 1: linear proportional, velocity (v = Δx / Δt), constant velocity (zero acceleration). Step 2: 0.40 m/s. Step 3: Claim: The line would curve and become flatter over time. Evidence: Slope represents velocity; as speed decreases, the ratio Δx/Δt per time interval decreases. Reasoning: A straight line indicates constant slope/speed; decreasing speed means less position gained per second, curving the graph towards a horizontal flatline."
    },
    "links": {
      "Wind-Up Toy Speed Lab": "Unit_2/wind_up_toy_lab/index.html",
      "Distance vs Time App": "distance_vs_time_graphing.html",
  ...
  },
  {
    ...
    "bellRinger": {
      ...
      "phenomenon": {
        ...
        "type": "text",
        "text": "NASA's Perseverance rover explores Jezero Crater on Mars. To avoid dangerous boulder fields, the rover drives 120 meters East along a curved sand dune, then turns and drives 50 meters North to reach a rock outcrop. Its mechanical wheel odometer records the total distance rolled, while orbital GPS measures its net change in position from the landing site."
      },
      "steps": [
        {
          "stepId": "step_1",
          "type": "cloze_dropdown",
          "title": "Part 1: Distinguishing Scalar and Vector Quantities",
          "prompt": "Select the correct kinematic terms to complete the analysis of the rover navigation log:",
          "text": "The rover wheel odometer records [blank1], which is a [blank2] quantity that depends on every twist and curve of the path. In contrast, the direct straight-line arrow from landing site to outcrop represents [blank3], which is a [blank4] quantity pointing from initial to final position.",
          "blanks": {
            "blank1": {
        ...
        },
        {
          "stepId": "step_2",
          "type": "data_calculation",
          "title": "Part 2: Vector Resultant Magnitude",
          "prompt": "Using the perpendicular legs of the journey (Δx = 120 m East, Δy = 50 m North), calculate the magnitude of the rover's net displacement vector in meters.",
          "inputLabel": "Displacement Magnitude",
          "unit": "m",
          "targetValue": 130,
          "tolerance": 1,
          "hint": "Use the Pythagorean relationship: c = sqrt(Δx² + Δy²) = sqrt(120² + 50²) = sqrt(14400 + 2500)."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
          "title": "Part 3: Defend Your Thinking (AI Physics Mentor)",
          "prompt": "Discuss your thinking with the AI Physics Mentor. Defend your distance vs displacement answers, and explain why a round trip gives 0 meters displacement but non-zero distance.",
          "openingMessage": "Nice job calculating that 130 m displacement! Now tell me: if the rover completes its mission and drives straight back to the landing site, why isn't its total distance zero? Defend your reasoning!",
          "quickChips": [
            "Displacement is zero because initial equals final position",
            "Scalar distance accumulates every meter rolled",
            "What if the rover took a winding return route?"
          ]
        }
      ],
      "teacherKey": "Step 1: total distance traveled, scalar, net displacement, vector. Step 2: 130 m. Step 3: Claim: Partially incorrect. Round-trip displacement is 0 m because initial position equals final position (Δx = x_final - x_initial = 0), but total distance traveled is 170 m + 130 m = 300 m (or 340 m depending on return route), because scalar distance accumulates all motion."
    },
    "assignments": [
      {
  ...
  },
  {
    ...
    "bellRinger": {
      ...
      "phenomenon": {
        "title": "The Desert Expedition Coordinate Mystery",
        "type": "text",
        "text": "A geological survey drone crashes in an uncharted sector of the desert. The emergency distress beacon transmits: 'Survey Drone Alpha located 50 kilometers away.' The search and rescue command team cannot dispatch recovery helicopters because a single scalar distance without an established reference origin or compass direction leaves a 360-degree circle of uncertainty."
      },
      "steps": [
        {
          "stepId": "step_1",
          "type": "cloze_dropdown",
          "title": "Part 1: Defining Spatial Position",
          "prompt": "Complete the scientific principle explaining why the distress beacon transmission is insufficient for navigation:",
          "text": "Describing an object's exact location requires specifying its position as a vector quantity relative to a defined [blank1]. A transmission stating only '50 km away' provides only [blank2], meaning the helicopter could search anywhere on the circumference of a circle without knowing the [blank3].",
          "blanks": {
            "blank1": {
        ...
        },
        {
          ...
          "prompt": "The rescue team establishes base camp as the coordinate origin (0, 0). The satellite grid map has a calibrated scale where 1 grid square = 2.5 km. If the drone is later pinpointed at coordinates (12, 16) grid units on the map, calculate its direct straight-line distance from base camp in kilometers.",
          "inputLabel": "Calculated Distance",
          "unit": "km",
          "targetValue": 50,
          "tolerance": 1,
          "hint": "Use the Pythagorean theorem: distance on grid = sqrt(12² + 16²) = sqrt(144 + 256) = sqrt(400) = 20 grid units. Then multiply by 2.5 km per unit."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
          "title": "Part 3: Defend Your Thinking (AI Physics Mentor)",
          "prompt": "Discuss your thinking with the AI Physics Mentor. Defend why your calculated distance and reference frame origin choices make scientific sense, and analyze what happens if base camp relocates.",
          "openingMessage": "Hey! I see your calculation and reference frame choices for the downed drone. Why do you think that specific origin and 50 km distance are correct? And what happens if base camp relocates 10 km south?",
          "quickChips": [
            "Moving base camp changes the numbers, not the actual drone",
            "I used the Pythagorean theorem to calculate the 50 km distance",
            "Why is a scalar distance without direction not enough?"
          ]
        }
      ],
      "teacherKey": "Step 1: reference frame / origin point, scalar distance (magnitude), directional bearing / angle. Step 2: 50 km (20 grid units · 2.5 km/unit). Step 3: Claim: False. Changing the origin changes the coordinate numbers assigned to the drone, but does not move the physical drone itself."
    },
    "assignments": [
      {
        "title": "Fantasy Map Worksheet",
