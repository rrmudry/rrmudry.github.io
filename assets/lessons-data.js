const lessonsData = [
  ...
  },
  {
    ...
    "assignments": [
      {
        "title": "The v<sub>f</sub> = v₀ + at Kinematic Velocity Equation Problem Set",
        "typeLabel": "Classwork Practice",
        "submission": "In-Class Handout (Subject to Pacing)",
        "actionLabel": "In-Class Activity Notice",
        "description": "Solve 8 multi-variable kinematics word problems isolating v<sub>f</sub>, v₀, a, and t using the GUESS methodology.",
        "status": "planned"
      }
    ],
    "resources": [
    ...
    "bellRinger": {
      ...
      "steps": [
        ...
        },
        {
          ...
          "prompt": "Calculate the slope of the v-t line in m/s² using the points (0.0, 4.0) and (6.0, 16.0): slope = (16.0 - 4.0) / (6.0 - 0.0).",
          "inputLabel": "Acceleration (Slope)",
          "unit": "m/s²",
          "targetValue": 2,
          "tolerance": 0.1,
          "hint": "slope = Δv / Δt = 12.0 m/s / 6.0 s = 2.0 m/s²."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
