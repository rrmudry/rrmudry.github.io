...
const lessonsData = [
  ...
  },
  {
    ...
    summary: "Photocopy Generation Lab & Teacher Demo.",
    details: "Hands-on simulation of signal degradation. Students observe why Analog signals get 'fuzzy' (Noise) over multiple generations while Digital signals stay clear.",
    type: "Lab",
    dok: 3,
    semester: 2,
    isFeatured: true,
  ...
  },
  {
    ...
    type: "Activity",
    links: { "Interactive AVID Notebook": "Unit_6_Waves_Radiation/Interactive_AVID_Notebook_Signals/signals.html" },
    dok: 2,
    semester: 2,
    isFeatured: true,
