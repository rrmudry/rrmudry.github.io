const lessonsData = [
  ...
  },
  {
    ...
    "bellRinger": {
      ...
      "phenomenon": {
        "title": "Electric Scout Vehicle: Velocity-Time Graph",
        "type": "graph",
        "text": "An electric scout cart starts from rest (v₀ = 0.0 m/s) and accelerates uniformly along a straight test track, reaching a final velocity of v_f = +10.0 m/s at t = 4.0 seconds. The shaded triangular area under the v-t line represents the cart's total displacement.",
        "graphData": {
          "title": "Velocity vs. Time: Scout Cart Uniform Acceleration",
          "chartType": "line",
          "showBestFit": false,
          "xAxis": {
            "label": "Time (t)",
      ...
      "steps": [
        {
          ...
          "prompt": "Inspect the v-t graph for the cart accelerating from rest:",
        ...
        },
        {
          ...
          "prompt": "Calculate the total distance traveled in meters from t = 0 to t = 4.0 s by finding the area of the shaded triangle on the graph: Area = ½ · base · height (base = 4.0 s, height = 10.0 m/s).",
        ...
        },
        {
          ...
          "prompt": "Discuss your reasoning with the AI Physics Mentor: Look at the shaded triangle on the graph. Explain why an accelerating object travels only HALF the distance of an object moving at the top speed the entire time, and during which half of the trip it covers more ground.",
          "openingPrompt": "You found that the shaded area under the v-t graph is 20.0 meters (Area = ½ · 4.0 s · 10.0 m/s)! Notice that if the cart had driven at its top speed of 10.0 m/s the entire 4 seconds, the area would be a 40.0-meter rectangle (10 × 4). Why does accelerating from rest create a triangle with exactly HALF of that area? And looking at the graph, during which 2 seconds did it travel more ground: 0 to 2 s (5.0 m) or 2 to 4 s (15.0 m)?",
          "minTurns": 1
        }
      ],
