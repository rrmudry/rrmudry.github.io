const lessonsData = [
  ...
  },
  {
    ...
    "date": "2026-09-18",
    "unit": 2,
    "title": "Constant Speed Story: Dual-Graph Edition (x-t & v-t)",
    "topic": "Creative Problem Authoring & Dual-Graph Motion Modeling (x-t Slope & v-t Area under the Curve)",
    "dok": 3,
    "type": "In-Class Performance Task",
    "semester": 1,
    "isFeatured": true,
    "image": "assets/images/constant_speed_story_exemplar.jpg",
    "summary": "Synthesize constant speed mastery through creative authoring and dual-graph modeling: students illustrate an original motion scenario, write an authentic word problem, solve it using the GUESS method, and plot both Position-Time (x-t) and Velocity-Time (v-t) graphs to prove that x-t slope equals velocity and v-t area equals displacement.",
    "activity": "Constant Speed Dual-Graph Story Workshop: Students invent and illustrate an original constant-speed motion scenario, compose a word problem targeting an unknown variable (v, d, or t), solve it using the GUESS method, and construct aligned Position-Time and Velocity-Time graphs on the back to verify their mathematical solution.",
    ...
    "wicor": {
      "Writing": "Authoring original physics narrative word problems and detailed GUESS algebraic solution proofs.",
      "Inquiry": "Determining custom coordinate axis scales and proving that x-t slope equals v-t height and v-t area equals total distance.",
      "Collaboration": "Peer-reviewing motion stories and cross-verifying dual-graph slopes and areas.",
      "Organization": "Structuring mathematical work using Givens, Unknown, Equation, Substitute, and Solve (GUESS).",
    ...
    "assignments": [
      {
        ...
        "submission": "Turn In Completed Worksheet (10 pts)",
        "actionLabel": "Open Worksheet PDF",
        "description": "Author an original constant speed motion story, illustrate the scene, solve using the GUESS method, and plot both Position-Time and Velocity-Time graphs on the back."
      }
    ],
    "resources": [
      {
        "title": "Teacher Master Key & Exemplar: Dual-Graph Story",
        "url": "Unit_2/worksheets/Teacher_Master_Key_Dual_Graph_Story.pdf",
        "typeLabel": "Teacher Exemplar / Master Key",
        "description": "Complete Mars Rover exemplar showing story authoring, GUESS proof, and aligned x-t and v-t graph proofs."
      },
      {
