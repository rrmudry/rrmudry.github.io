const lessonsData = [
    ...
    "assignments": [
      {
        "title": "Velocity vs. Time Graph Studio",
        "url": "Unit_2/velocity_time_graph_studio/index.html",
        "typeLabel": "Interactive Studio & Visualizer",
        "submission": "Submit in Web App / Classwork",
        "actionLabel": "Launch Studio 🚀",
        "description": "Explore displacement as geometric area under the velocity-time curve with 1D car motion."
      },
      {
  ...
  },
  {
    ...
    "date": "2026-09-25",
    "unit": 2,
    "title": "Autonomous Vehicle Forensic Crash Reconstruction & Kinematic Synthesis",
    "topic": "Forensic 1D Kinematic Reconstruction: Multi-Stage Acceleration, Reaction Latency, and Error Sensitivity Modeling",
    "dok": 4,
    "type": "Forensic Investigation / Performance Task",
    "semester": 1,
    "isFeatured": true,
    "summary": "Lead an authentic forensic engineering investigation reconstructing an autonomous delivery shuttle collision at a traffic intersection. Students synthesize reaction time latencies, quadratic braking deceleration curves, and GPS telemetry, conducting parameter sensitivity analysis to defend a formal forensic claim on liability.",
    ...
    "essentialQuestion": "How do forensic engineers synthesize multi-stage kinematic models and sensor uncertainty to determine the true sequence and root cause of a vehicular collision?",
    "standards": [
      "HS-PS2-1",
      "HS-ETS1-2"
    ],
    "wicor": {
      "Writing": "Authoring a formal Forensic Engineering Collision Report with executive summary, mathematical proof, and evidentiary claims.",
      "Inquiry": "Investigating parameter sensitivity: testing how altering initial velocity and reaction delay expands the collision zone.",
      "Collaboration": "Forensic reconstruction partner roles: telemetry analyst, mathematical modeler, and technical lead.",
      "Organization": "Synthesizing disparate evidentiary exhibits (GPS tables, sensor traces, video stills) into a unified timeline.",
      "Reading": "Interpreting technical sensor logs, police collision diagrams, and municipal traffic telemetry standards."
    },
    "bellRinger": {
      "type": "free_response",
    ...
    "assignments": [
      {
        "title": "Autonomous Vehicle Forensic Collision Investigation Report",
        "typeLabel": "DOK 4 Forensic Investigation",
        "submission": "In-Class Handout (Subject to Pacing)",
        "actionLabel": "In-Class Activity Notice",
        "description": "Analyze multi-sensor crash telemetry, model multi-stage stopping distances, and submit a formal liability defense report.",
        "status": "planned"
      }
    ],
    "resources": [
      {
        "title": "Forensic Crash Reconstruction Methodology Guide",
        "url": "https://docs.google.com/presentation/d/10-afry9hEiN-b1U_qzE--Z5f7CUKvfde_nuPIWVNJgk/edit?usp=sharing",
        "typeLabel": "Technical Methodology",
        "description": "Guide to partitioning piecewise motion phases, calculating reaction distance, and evaluating accelerometer telemetry."
      },
      {
        "title": "Two-Car Kinematic Intercept Simulator",
        "url": "Unit_2/two_car_intercept/index.html",
        "typeLabel": "Simulation Tool",
        "description": "Model autonomous shuttle pursuit and intersection intercept kinematics."
      }
    ],
    "practice": [
      {
        "title": "Two-Car Intercept Challenge Sandbox",
        "url": "Unit_2/two_car_intercept/index.html",
        "typeLabel": "Interactive Simulator",
        "description": "Test collision envelope scenarios."
      }
    ],
    "links": {
      "Forensic Methodology Guide": "https://docs.google.com/presentation/d/10-afry9hEiN-b1U_qzE--Z5f7CUKvfde_nuPIWVNJgk/edit?usp=sharing",
  ...
  },
  {
    ...
    "activity": "Comparative Traction Protocol & Highway Safety Specification (DOK 4 Extended Investigation): Teams act as highway safety research consultants. Rather than following a step-by-step procedure, teams must: (1) independently formulate and carry out two distinct experimental protocols to measure friction coefficients on road materials (horizontal force sensor drag vs. critical angle of incline slip where mu_s = tan(theta)), (2) identify and reconcile discrepancies between the methods by analyzing contact temperature, surface wear, and stick-slip chatter, and (3) synthesize empirical friction coefficients with Newton's 2nd Law and kinematics to calculate stopping distance envelopes and specify safe wet-weather speed limits for a banked mountain highway curve.",
    ...
    "resources": [
      {
        ...
        "description": "Comparing drag force sensors vs critical incline slip angles (mu_s = tan theta) and highway banking equations."
      },
      {
        "title": "Two-Car Kinematic Intercept Simulator",
        "url": "Unit_2/two_car_intercept/index.html",
