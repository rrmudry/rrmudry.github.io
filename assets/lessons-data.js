const lessonsData = [
  ...
  },
  {
    ...
    "date": "2026-09-18",
    "unit": 2,
    "title": "Constant Speed Story: 3-Stage Dual-Graph Edition (x-t & v-t)",
    ...
    "assignments": [
      {
        "title": "Constant Speed Story: 3-Stage Dual-Graph Edition (x-t & v-t)",
        "url": "Unit_2/worksheets/Constant_Speed_Dual_Graph_Story.pdf",
        "typeLabel": "In-Class Performance Task",
        "submission": "Turn In Completed Worksheet (10 pts)",
        "actionLabel": "Open Worksheet PDF",
        "description": "Author an original 3-section constant speed motion story (over 10.0s), illustrate the journey, solve each section's velocity using GUESS in the data table, and plot both Position-Time and Velocity-Time graphs on the back."
      }
    ],
    "resources": [
      {
        "title": "Teacher Master Key & Exemplar: 3-Stage Dual-Graph Story",
        "url": "Unit_2/worksheets/Teacher_Master_Key_Dual_Graph_Story.pdf",
        "typeLabel": "Teacher Exemplar / Master Key",
        "description": "Complete Mars Rover worked exemplar (Scenario 1) showing 3-stage story authoring, GUESS table proofs, and aligned x-t and v-t graph proofs with 10-pt rubric."
      },
      {
      ...
      {
        "title": "Student Work Exemplar (Day 10 Story)",
        "url": "assets/images/constant_speed_story_exemplar.jpg",
        "typeLabel": "Student Visual Guide",
        "description": "Visual guide showing illustrated motion scene and GUESS proof."
      }
    ],
    "practice": [
      {
    ...
    "links": {
      "Constant Speed Dual-Graph Story Worksheet": "Unit_2/worksheets/Constant_Speed_Dual_Graph_Story.pdf",
      "Teacher Master Key & Exemplar": "Unit_2/worksheets/Teacher_Master_Key_Dual_Graph_Story.pdf",
      "Dual-Graph Motion Studio": "Unit_2/dual_graph_studio/index.html",
      "Velocity vs. Time Visualizer": "Unit_2/velocity_time_graph_studio/index.html"
    }
  },
