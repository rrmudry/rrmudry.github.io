const lessonsData = [
  ...
  },
  {
    ...
    "bellRinger": {
      ...
      "explanation": "Total distance traveled is 30 km (15 + 15), but net displacement is 0 km because their final position is identical to their starting position (Δx = x<sub>final</sub> - x<sub>initial</sub> = 0).",
      "defaultDuration": 3
    },
    "assignments": [
      {
  ...
  },
  {
    ...
    "bellRinger": {
      "type": "cast_challenge",
      "title": "Vector Displacement vs Path Distance",
      "defaultDuration": 4,
      "standards": {
        "dci": "HS-PS2.A: Forces & Motion",
        "sep": "SEP-5: Mathematical & Computational Thinking",
      ...
      "steps": [
        {
          "stepId": "step_1",
          "type": "cloze_dropdown",
          "title": "Part 1: Reading Rover Motion States",
          "prompt": "Examine the telemetry coordinates table to match each rover's physical state of motion and velocity (v = Δx / Δt):",
          "text": "During the first 4.0 seconds, Rover Alpha moves from 0 m to 16 m at a steady velocity of [blank1]. During that same time, Rover Beta stays at position 12.0 m, meaning it is [blank2]. Between t = 4.0 s and t = 10.0 s, Rover Beta gains 12 m in 6 s (12 m / 6 s), traveling at a velocity of [blank3].",
          "blanks": {
            "blank1": {
              "correct": "+4.0 m/s (moves +16 m in 4 s)",
              "options": [
                "+4.0 m/s (moves +16 m in 4 s)",
                "+2.0 m/s (moves +8 m in 4 s)",
                "+16.0 m/s (moves +64 m in 4 s)"
              ]
            },
            "blank2": {
              "correct": "at rest / stopped (velocity = 0 m/s)",
              "options": [
                "at rest / stopped (velocity = 0 m/s)",
                "moving forward at +3.0 m/s",
                "reversing backward at -3.0 m/s"
              ]
            },
            "blank3": {
              "correct": "+2.0 m/s (steady forward)",
              "options": [
                "+2.0 m/s (steady forward)",
                "+4.0 m/s (speeding forward)",
                "at rest (stopped)"
              ]
            }
          }
        },
        {
          ...
          "prompt": "Rover Alpha travels forward at a constant 4.0 m/s starting from 0 m. Rover Beta is stopped ahead at the 12.0 m mark. How many seconds does it take for Rover Alpha to catch up and reach x = 12.0 m?",
          "inputLabel": "Catch-Up Time (s):",
          "unit": "s",
          "targetValue": 3,
          "tolerance": 0.1,
          "hint": "Formula: Time = Distance / Velocity. Here: Time = 12.0 m / (4.0 m/s) = 3.0 seconds."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
  ...
  },
  {
    ...
    "date": "2026-09-16",
    "unit": 2,
    "title": "Marble Ramp Motion & Graphing Lab: Position-Time & Velocity-Time Data Collection",
    "topic": "Empirical Measurement of Constant Speed, Replication Averaging, and Click-to-Plot x-t & v-t Graphing",
    "dok": 3,
    "type": "Lab Investigation",
    "semester": 1,
    "isFeatured": true,
    "summary": "Hands-on lab investigation using a grooved ruler ramp elevated by book stacks: students time a marble's constant-speed travel across a flat table for 3 ramp heights, calculate averages and speeds, then click to plot Position vs. Time and Velocity vs. Time graphs to discover that slope = speed and area under velocity = distance.",
    "activity": "Marble Ramp Motion & Graphing Lab: Student teams elevate a wooden ruler ramp using 1, 2, and 3 book stacks and release a marble from rest (level with the top book). The marble rolls down the ramp and travels across a flat table at approximately constant speed. Students measure the stack height, then use a built-in digital stopwatch to time 3 replications for each ramp height across a marked table distance. After calculating average times and speeds, students click to plot data points on interactive Position vs. Time and Velocity vs. Time canvases. Slope triangles on x-t graphs reveal speed; horizontal lines and shaded area rectangles on v-t graphs connect velocity to displacement. A CER synthesis ties ramp height to speed, slope steepness, and multi-trial averaging.",
    "essentialQuestion": "How does increasing ramp height change the marble's constant speed across the table, and how do we see this relationship in the slopes and areas of motion graphs?",
    "standards": [
      "HS-PS2-1"
    ],
    "wicor": {
      "Writing": "Composing a Claim-Evidence-Reasoning (CER) scientific explanation connecting ramp elevation to marble speed, graph slopes, and multi-trial data quality.",
      "Inquiry": "Designing and executing 3 replicated timing trials per ramp height, detecting outliers, and calculating average times and speeds from authentic stopwatch data.",
      "Collaboration": "Lab team coordination: one student releases the marble, each student independently times the run, and the team compares and discusses data quality.",
      "Organization": "Systematic data recording across 3 ramp heights x 3 trials, organized into a structured digital lab notebook with automatic cloud saving.",
      "Reading": "Interpreting position-time slope triangles and velocity-time area rectangles to extract physical meaning from graphical representations of motion."
    },
    "bellRinger": {
      "type": "concept_chat",
      "title": "Ramp Height & Rolling Speed",
      "promptQuestion": "Before we start the lab: If you release a marble from the top of a steeper ramp, do you think it will roll faster or slower across the table compared to a shallow ramp? Why?",
      "explanation": "A steeper ramp converts more gravitational potential energy into kinetic energy, giving the marble a higher exit speed at the bottom. The marble then travels at a faster constant speed across the flat table surface.",
      "defaultDuration": 3
    },
    "assignments": [
      {
        "title": "Marble Ramp Motion & Graphing Lab",
        "url": "Unit_2/marble_ramp_lab/index.html",
        "typeLabel": "Graded Lab Investigation",
        "submission": "Submit in Web App (Synced to Gradebook)",
        "actionLabel": "Launch Lab 🚀",
        "description": "6-step guided lab: measure stack heights, time marble runs with the digital stopwatch, calculate averages & speeds, click to plot x-t and v-t graphs, and write a CER synthesis.",
        "points": 10
      }
    ],
    "resources": [
      {
        "title": "Position vs. Time Graphing Studio",
        "url": "Unit_2/position_time_graph_studio/index.html",
        "typeLabel": "Interactive Studio",
        "description": "Practice plotting and interpreting position-time graphs with slope analysis."
      },
      {
        "title": "Velocity vs. Time (v-t) Graph & Motion Visualizer",
        "url": "Unit_2/velocity_time_graph_studio/index.html",
        "typeLabel": "Interactive Visualizer",
        "description": "Compare constant speed vs. uniform acceleration with 1D car track and area analysis."
      }
    ],
    "practice": [
      {
        ...
        "url": "Unit_2/speed_distance_time_app/index.html",
        "typeLabel": "Practice Sandbox",
        "description": "Practice speed, distance, and time calculations."
      }
    ],
    "links": {
      "Marble Ramp Lab": "Unit_2/marble_ramp_lab/index.html",
      "Position vs. Time Graphing Studio": "Unit_2/position_time_graph_studio/index.html",
      "Velocity vs. Time Visualizer": "Unit_2/velocity_time_graph_studio/index.html",
      "Speed & Distance Studio": "Unit_2/speed_distance_time_app/index.html"
    }
  },
  {
    ...
    "date": "2026-09-17",
    "unit": 2,
    "title": "Kinematics Graphing Workshop & Mid-Unit Studio Work Day",
    "topic": "1D Constant Velocity Graphing Challenges (Challenges 1 & 2) & Conceptual Physics Lab Completion",
    "dok": 2,
    "type": "Workshop / Guided Practice",
    "semester": 1,
    "isFeatured": true,
    "summary": "In-class studio work day: Conceptual Physics classes finalize the Marble Ramp Motion & Graphing Lab and core constant speed problem sets; Physics-Regular and Honors Physics tackle Kinematics Graphing Challenges 1 & 2, plotting piecewise constant-speed journeys on coordinate grids and solving for velocity slopes and spatial-temporal intercepts.",
    "activity": "Period 0 Honors & Periods 1–6 Physics-Regular: Kinematics Graphing Challenges 1 & 2 (Oceanic Rendezvous & Highway Surveillance Intercept) — plot piecewise 1D motions on calibrated coordinate grids, calculate intercept coordinates, and analyze velocity slopes. Conceptual Physics: In-class studio workshop to finish up the Marble Ramp Motion & Graphing Lab, coordinate slope calculations, and missing Unit 2 coursework.",
    "essentialQuestion": "How do coordinate grids allow us to predict the exact time and location where two objects moving at constant speeds intercept?",
    "standards": [
      "HS-PS2-1"
    ],
    "wicor": {
      "Writing": "Documenting algebraic intercept solutions and coordinate slope interpretations.",
      "Inquiry": "Analyzing how differing constant velocities and head starts produce single-point graphical intersections.",
      "Collaboration": "Partner problem-solving on multi-stage transit tracks and peer-checking slope triangles.",
      "Organization": "Structuring multi-phase motion tables and setting up 2-page challenge worksheets.",
      "Reading": "Extracting speed, direction, and starting positions from real-world nautical and vehicular scenarios."
    },
    "bellRinger": {
      "type": "cast_challenge",
      "title": "Constant Velocity Graphing & Intercept Analysis",
      "defaultDuration": 4,
      "standards": {
        "dci": "HS-PS2.A: Forces & Motion",
        "sep": "SEP-4: Analyzing & Interpreting Data",
      ...
      "phenomenon": {
        "title": "Transit Corridor Two-Vehicle Intercept",
        "description": "Two delivery drones cruise along a straight aerial delivery corridor at constant speeds. Drone A leaves the depot at t = 0 with a constant speed of 10.0 m/s. Drone B leaves a relay hub 60.0 meters ahead at t = 0 with a constant speed of 5.0 m/s in the same direction.",
        "stimulus": {
          "type": "data_table",
          ...
          "rows": [
            {
              ...
              "col_1": "0.0 m",
              "col_2": "+10.0 m/s",
              "col_3": "x<sub>A</sub>(t) = 10.0 · t"
            },
            {
              "col_0": "Drone Beta",
              "col_1": "+60.0 m",
              "col_2": "+5.0 m/s",
              "col_3": "x<sub>B</sub>(t) = 60.0 + 5.0 · t"
            }
          ]
        }
      },
      "steps": [
        {
          "stepId": "step_1",
          "type": "cloze_dropdown",
          "title": "Part 1: Graphical Slopes & Motion Rates",
          "prompt": "Analyze the motion of the two drones on a Position vs. Time (x-t) graph:",
          "text": "On an x-t graph, Drone Alpha has a [blank1] slope than Drone Beta. The vertical-axis intercept (y-intercept) of Drone Beta is at [blank2].",
          "blanks": {
            "blank1": {
              "correct": "steeper (faster speed)",
              "options": [
                "steeper (faster speed)",
                "shallower (slower speed)",
                "flat (zero speed)"
              ]
            },
            "blank2": {
        ...
        },
        {
          ...
          "type": "data_calculation",
          "title": "Part 2: Intercept Time Calculation",
          "prompt": "Equate their position equations (10.0 · t = 60.0 + 5.0 · t) to calculate the intercept time (t) in seconds when Drone Alpha catches Drone Beta.",
          "inputLabel": "Intercept Time",
          "unit": "s",
          "targetValue": 12,
          "tolerance": 0.1,
          "hint": "Subtract 5.0t from both sides: 5.0 · t = 60.0, so t = 60.0 / 5.0 = 12.0 s."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
          "title": "Part 3: Intercept Position Verification with AI Mentor",
          "prompt": "Discuss your reasoning with the AI Physics Mentor: Explain where the two drones meet and how you can verify your answer using both drones' equations.",
          "openingPrompt": "You calculated that Drone Alpha catches Drone Beta at t = 12.0 seconds! At what exact position coordinate (in meters) do they intercept, and how can you prove this is correct?",
          "minTurns": 1
        }
      ],
      "teacherKey": "Step 1: steeper (faster speed), x = +60.0 m. Step 2: 12.0 s (60.0 / 5.0). Step 3: Claim: The drones intercept at coordinate position x = 120.0 meters. Evidence: For Drone Alpha: x<sub>A</sub>(12.0) = 10.0 m/s · 12.0 s = 120.0 m. For Drone Beta: x<sub>B</sub>(12.0) = 60.0 m + (5.0 m/s · 12.0 s) = 60.0 + 60.0 = 120.0 m. Reasoning: Both equations yield the exact same spatial coordinate x = 120.0 m at t = 12.0 s, which represents the intersection point of their position-time lines."
    },
    "assignments": [
      {
        "title": "Kinematics Graphing Challenges 1 & 2 (Physics-Regular)",
        "url": "Unit_2/worksheets/Kinematics_Graphing_Challenges_1_and_2.pdf",
        "typeLabel": "Physics-Regular",
        "submission": "Turn In Completed Worksheet (10 pts)",
        "actionLabel": "Open Worksheet PDF",
        "description": "Periods 1–6 Physics-Regular: Plot constant-speed motion journeys, track intercepts, and calculate required speeds from graph slopes."
      },
      {
      ...
      {
        "title": "Marble Ramp Lab Completion (Conceptual Physics)",
        "url": "Unit_2/marble_ramp_lab/index.html",
        "typeLabel": "Conceptual Physics",
        "submission": "Submit Completed Data & CER in Classroom",
        "actionLabel": "Open Marble Ramp Lab",
        "description": "Periods 1–6 Conceptual Physics: Finalize ramp height timing trials, click-to-plot graphs, and CER synthesis."
      }
    ],
    "resources": [
      {
      ...
      },
      {
        ...
        "description": "Plot position curves, calculate slopes, and inspect instantaneous vs. average velocities."
      },
      {
        "title": "Speed & Distance Studio",
        "url": "Unit_2/speed_distance_time_app/index.html",
        "typeLabel": "Calculation Studio",
        "description": "Practice formula rearrangements and multi-step speed challenges."
      }
    ],
    "practice": [
      {
        ...
        "description": "Explore 3-stage constant speed journeys and graph slopes."
      }
    ],
    "links": {
      "Kinematics Graphing Challenges 1 & 2 (Physics-Regular)": "Unit_2/worksheets/Kinematics_Graphing_Challenges_1_and_2.pdf",
  ...
  },
  {
    ...
    "date": "2026-09-18",
    "unit": 2,
    "title": "Graphing Speed Story: 3-Stage Dual-Graph Edition",
    "topic": "Creative 3-Section Motion Authoring & Dual-Graph Modeling (x-t Slope & v-t Area under the Curve)",
    "dok": 3,
    "type": "In-Class Performance Task",
    "semester": 1,
    "isFeatured": true,
    "image": "assets/images/graphing_speed_story_exemplar.jpg",
    "exemplarTitle": "Completed Student Exemplar: Leo Rodriguez (Score: 9/10)",
    "exemplarDescription": "Authentic student exemplar demonstrating the complete 3-stage motion workflow: character scenario narrative, hand-drawn comic sequence, calibrated Position-Time and Velocity-Time graphs, velocity calculations, and shaded area displacement proofs.",
    "summary": "Synthesize constant speed mastery through creative authoring and 3-stage dual-graph modeling: students illustrate an original 3-section motion scenario across 10.0 seconds (like the Dual-Graph Studio), author their narrative, solve for each section's velocity using GUESS, and plot both Position-Time (x-t) and Velocity-Time (v-t) graphs to prove that slopes equal velocities and shaded areas equal displacements.",
    "activity": "Constant Speed 3-Stage Dual-Graph Story Workshop: Students invent and illustrate an original 3-section constant-speed motion journey (e.g. forward, stopped, reverse over 10s), compose a 3-part narrative, calculate velocities for each section in the motion data table, and construct aligned Position-Time and Velocity-Time graphs on the back to verify their mathematical solution.",
    "essentialQuestion": "How do Position-Time and Velocity-Time graphs provide complementary visual proofs of an object's speed and displacement?",
    "standards": [
      "HS-PS2-1"
    ],
    "wicor": {
      "Writing": "Authoring original 3-stage physics narrative word problems and detailed GUESS algebraic solution proofs.",
      "Inquiry": "Proving that x-t slopes equal v-t heights and the sum of v-t shaded areas equals net displacement.",
      "Collaboration": "Peer-reviewing 3-stage motion stories and cross-verifying dual-graph slopes and areas.",
      "Organization": "Structuring multi-phase mathematical work using Givens, Unknown, Equation, Substitute, and Solve (GUESS).",
      "Reading": "Interpreting word problems to extract kinematic variables and coordinate reference points."
    },
    "bellRinger": {
      "type": "cast_challenge",
      "title": "Dual-Graph Translation: Slope and Area Under the Curve",
      "defaultDuration": 4,
      "standards": {
        "dci": "HS-PS2.A: Forces & Motion",
      ...
      "phenomenon": {
        "title": "Subsea Exploration Probe Telemetry",
        "description": "An autonomous subsea research drone cruises at a constant speed along a trench floor. Mission control tracks its Position vs. Time and Velocity vs. Time telemetry.",
        "stimulus": {
          "type": "data_table",
          "title": "Subsea Drone Mission Parameters",
          "headers": [
            "Parameter",
            "Symbol",
            "Value",
          ...
          "rows": [
            {
              ...
              "col_1": "Δt",
              "col_2": "25.0 seconds",
              "col_3": "Horizontal axis width on both graphs"
            },
            {
              "col_0": "Cruising Speed",
              "col_1": "v",
              "col_2": "4.0 m/s",
              "col_3": "Slope of x-t line / Height of v-t line"
            },
            {
              "col_0": "Total Displacement",
              "col_1": "Δx",
              "col_2": "100.0 meters",
              "col_3": "Final position on x-t / Shaded area under v-t"
            }
          ]
        }
      },
      "steps": [
        {
          "stepId": "step_1",
          "type": "cloze_dropdown",
          "title": "Part 1: Graphical Motion Principles",
          "prompt": "Identify the fundamental physical meaning of each graph feature:",
          "text": "On a Position-Time graph, the slope represents [blank1]. On a Velocity-Time graph, a flat horizontal line represents [blank2], and the shaded rectangular area under the line represents [blank3].",
          "blanks": {
            "blank1": {
              "correct": "velocity (speed and direction)",
              "options": [
            ...
            "blank2": {
              "correct": "constant speed (zero acceleration)",
              "options": [
            ...
            "blank3": {
              "correct": "distance / displacement traveled",
              "options": [
        ...
        },
        {
          "stepId": "step_2",
          "type": "data_calculation",
          "title": "Part 2: Area under the Curve Calculation",
          "prompt": "Calculate the shaded area under the v-t curve in meters for a drone cruising at 4.0 m/s for 25.0 seconds (Area = height × width = v · Δt).",
          "inputLabel": "Displacement from Area",
          "unit": "m",
          "targetValue": 100,
          "tolerance": 0.1,
          "hint": "Area = velocity × time = (4.0 m/s)(25.0 s) = 100.0 meters."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
          "title": "Part 3: Defending Dual-Graph Geometry with AI Mentor",
          "prompt": "Discuss your reasoning with the AI Physics Mentor: Explain why calculating the geometric area under a velocity-time graph (multiplying height by width) gives the exact same result as multiplying speed by time in the distance formula.",
          "openingPrompt": "The rectangular area under the 4.0 m/s velocity line for 25.0 seconds is 100.0 meters! Look at the units of the rectangle: the height is in meters per second (m/s) and the width is in seconds (s). What happens mathematically to the seconds when you multiply height by width? How does that prove the area MUST be distance?",
          "minTurns": 1
        }
      ],
      "teacherKey": "Step 1: velocity, constant speed, distance/displacement. Step 2: 100.0 meters (4.0 m/s · 25.0 s). Step 3: Claim: The area of a rectangular region on a v-t graph equals distance because multiplying the dimensions (m/s) · (s) cancels out the seconds unit, leaving meters. Evidence: Height = 4.0 m/s, Width = 25.0 s. Area = (4.0 m/s) · (25.0 s) = 100 m. Reasoning: Geometry mirrors dimensional analysis. Whenever you compute the area under a rate-time curve, you integrate the rate over time, yielding the total accumulated quantity."
    },
    "assignments": [
      {
        "title": "Graphing Speed Story",
        "url": "Unit_2/worksheets/Graphing_Speed_Story.pdf",
        "typeLabel": "In-Class Performance Task",
        "submission": "Turn In Completed Worksheet (10 pts)",
        "actionLabel": "Open Worksheet PDF",
        "description": "Invent an original character/vehicle journey across 3 distinct motion sections over 10.0 seconds (like the Dual-Graph Studio). Illustrate the scene, author your short story, and calculate the velocities and prove your math with both graphs!"
      }
    ],
    "resources": [
      {
        "title": "Dual-Graph Motion Studio (x-t to v-t)",
        "url": "Unit_2/dual_graph_studio/index.html",
        "typeLabel": "Interactive Simulation Studio",
        "description": "Interactive tool to compare position slopes and velocity intervals."
      },
      {
        "title": "Completed Student Exemplar (Leo Rodriguez)",
        "url": "assets/images/graphing_speed_story_exemplar.jpg",
        "typeLabel": "Student Visual Guide",
        "description": "Visual reference demonstrating 3-stage skateboard narrative, illustrated comic sequence, calibrated graphs, and velocity/displacement proofs."
      }
    ],
    "practice": [
      {
        "title": "Velocity vs. Time (v-t) Graph Studio",
        "url": "Unit_2/velocity_time_graph_studio/index.html",
        "typeLabel": "Interactive Visualizer",
        "description": "Inspect horizontal velocity lines and area under the curve."
      },
      {
        "title": "Speed & Distance Studio",
        "url": "Unit_2/speed_distance_time_app/index.html",
        "typeLabel": "Practice Sandbox",
        "description": "Practice formula triangle calculations before graphing."
      }
    ],
    "links": {
      "Graphing Speed Story Worksheet": "Unit_2/worksheets/Graphing_Speed_Story.pdf",
      "Student Work Exemplar": "assets/images/graphing_speed_story_exemplar.jpg",
      "Dual-Graph Motion Studio": "Unit_2/dual_graph_studio/index.html",
      "Velocity vs. Time Visualizer": "Unit_2/velocity_time_graph_studio/index.html"
    }
  },
  {
    ...
    "date": "2026-09-21",
    "unit": 2,
    "title": "Introducing Acceleration: Velocity Changes & Rate of Change (a = Δv / Δt)",
    "topic": "Calculating Velocity Changes (Δv), Time Intervals (Δt), Units (m/s²), and Sign Conventions",
    "dok": 2,
    "type": "Direct Instruction / Guided Practice",
    "semester": 1,
    "isFeatured": true,
    "summary": "Define acceleration as the rate of change of velocity (a = Δv / Δt = (v - v₀) / t), practice calculating velocity differences (Δv = v - v₀) and elapsed time (Δt), interpret the physical meaning of m/s², and resolve the fundamental sign misconception of speeding up vs. slowing down.",
    ...
    "essentialQuestion": "How does the sign of acceleration combine with the sign of velocity to determine whether an object is speeding up or slowing down?",
    "standards": [
      "HS-PS2-1"
    ],
    "wicor": {
      "Writing": "Formulating CER explanations explaining why negative acceleration can result in speeding up in the negative direction.",
      "Inquiry": "Testing motion carts on ramps to observe how the direction of acceleration is independent of the initial push direction.",
      "Collaboration": "Small-group whiteboard sprint categorizing motion scenarios into the 2x2 velocity-acceleration sign matrix.",
      "Organization": "Creating an Acceleration Sign Rule Reference Sheet and Δv calculation guide.",
      "Reading": "Deconstructing physics word problems to identify initial velocity (v₀), final velocity (v), and time elapsed (t)."
    },
    "bellRinger": {
      "type": "cast_challenge",
          ...
          "rows": [
            {
              ...
              "col_1": "+12.0 m/s",
              "col_2": "+3.0 m/s²",
              "col_3": "Heading Right, Positive Thrust"
            },
            {
              "col_0": "Pod Beta",
              "col_1": "+18.0 m/s",
              "col_2": "-4.0 m/s²",
              "col_3": "Heading Right, Reverse Braking"
            },
            {
              "col_0": "Pod Gamma",
              "col_1": "-8.0 m/s",
              "col_2": "-2.0 m/s²",
              "col_3": "Heading Left, Leftward Thrust"
            },
            {
              "col_0": "Pod Delta",
              "col_1": "-14.0 m/s",
              "col_2": "+5.0 m/s²",
              "col_3": "Heading Left, Rightward Braking"
            }
          ]
        }
      },
    ...
    "assignments": [
      {
        ...
        "typeLabel": "Interactive Webapp & Mastery Lab",
        "submission": "Online Firestore Grade Sync",
        "actionLabel": "Launch Studio",
    ...
    "resources": [
      ...
      },
      {
        ...
        "description": "Interactive dual-vector simulator, 2x2 sign matrix, and scaffolded GUESS problem solver."
      },
      {
        "title": "Velocity vs. Time Visualizer",
        "url": "Unit_2/velocity_time_graph_studio/index.html",
        "typeLabel": "Interactive Web Tool",
        "description": "Explore constant acceleration and slope on velocity-time graphs."
      },
      {
        "title": "Interactive Distance vs. Time Grapher",
        "url": "https://rrmudry.github.io/distance_vs_time_graphing.html",
    ...
    "practice": [
      {
        "title": "Acceleration Rate & Sign Studio",
        "url": "Unit_2/acceleration_studio/index.html",
        "typeLabel": "Mastery Challenge",
        "description": "Master matching/opposing vector signs, (m/s)/s rate accumulation, and emergency braking intercepts."
      },
      {
        "title": "Velocity vs. Time Visualizer",
        "url": "Unit_2/velocity_time_graph_studio/index.html",
        "typeLabel": "Practice Tool",
        "description": "Observe positive and negative slope acceleration on v-t graphs."
      }
    ],
    "links": {
  ...
  },
  {
    ...
    "date": "2026-09-22",
    "unit": 2,
    "title": "The Kinematic Velocity Equation: Calculating Final Velocity (v<sub>f</sub> = v₀ + at)",
    "topic": "Algebraic Isolation of Variables: Solving for Final Velocity, Initial Velocity, Acceleration, and Time",
    "dok": 2,
    "type": "Guided Practice / Problem Solving",
    "semester": 1,
    "isFeatured": true,
    "summary": "Master algebraic manipulation of the acceleration definition by deriving the first linear kinematic equation: v<sub>f</sub> = v₀ + at. Students practice variable isolation using the GUESS method to solve for final velocity (v<sub>f</sub>), initial velocity (v₀), acceleration (a), and time elapsed (t).",
    "activity": "Kinematic Velocity Sprint: Scaffolded problem-solving workshop tackling real-world vehicular acceleration (highway merging, aircraft runway takeoff runs, and high-speed emergency braking to rest where v<sub>f</sub> = 0). Students show full GUESS algebraic setups for each unknown variable.",
    "essentialQuestion": "How does algebraically rearranging the acceleration equation allow us to predict an object's future velocity or determine how long an acceleration took?",
    "standards": [
      "HS-PS2-1"
    ],
    "wicor": {
      "Writing": "Structuring step-by-step algebraic solutions using Givens, Unknown, Equation, Substitute, and Solve (GUESS).",
      "Inquiry": "Comparing how differing acceleration rates affect the time required to reach safe highway merge speeds.",
      "Collaboration": "Partner problem-solving pairs: variable identifier and algebraic equation solver.",
      "Organization": "Constructing an Algebraic Variable Isolation Matrix showing formulas solved for v<sub>f</sub>, v₀, a, and t.",
      "Reading": "Translating contextual narrative clues (e.g. 'starts from rest' -> v₀ = 0; 'comes to a stop' -> v<sub>f</sub> = 0) into explicit numerical values."
    },
    "bellRinger": {
      "type": "cast_challenge",
    ...
    "assignments": [
      {
        ...
        "description": "Solve linear kinematic word problems isolating final velocity (vf), initial velocity (vo), acceleration (a), and elapsed time (t) across 3 scaffolded tiers with Desmos verification.",
        "status": "active"
      }
    ],
    "resources": [
      ...
      },
      {
        ...
        "url": "Unit_2/velocity_time_graph_studio/index.html",
        "typeLabel": "Interactive Web Tool",
        "description": "Observe dynamic changes in final velocity as slope and time vary."
      },
      {
        "title": "Interactive Distance vs. Time Grapher",
        "url": "https://rrmudry.github.io/distance_vs_time_graphing.html",
        "typeLabel": "Interactive Web Tool",
        "description": "Simulate position curves resulting from constant acceleration."
      }
    ],
    "practice": [
      {
      ...
      },
      {
        ...
        "url": "Unit_2/velocity_time_graph_studio/index.html",
        "typeLabel": "Practice Tool",
        "description": "Test vehicle acceleration rates and final speeds."
      }
    ],
    "links": {
  ...
  },
  {
    ...
    "bellRinger": {
      "type": "cast_challenge",
      "title": "Velocity-Time Slope & Acceleration Analysis",
      "defaultDuration": 4,
      "standards": {
        "dci": "HS-PS2.A: Forces & Motion",
        "sep": "SEP-4: Analyzing & Interpreting Data",
      ...
      "phenomenon": {
        "title": "Autonomous Delivery Drone Velocity Trace",
        "description": "An automated aerial drone accelerates along a launch rail. Flight telemetry records its velocity across a 6.0-second interval starting from an initial velocity of +4.0 m/s and accelerating to +16.0 m/s.",
        "stimulus": {
          "type": "data_table",
          "title": "Drone Launch Rail v-t Telemetry",
          "headers": [
            "Elapsed Time (t)",
            "Velocity (v)",
            "Coordinate Point (t, v)"
          ],
          "rows": [
            {
              "col_0": "0.0 s",
      ...
      "steps": [
        {
          "stepId": "step_1",
          "type": "cloze_dropdown",
          "title": "Part 1: Reading the v-t Graph Intercept & Line Shape",
          "prompt": "Analyze the coordinate data from the drone launch rail telemetry:",
          "text": "On a Velocity-Time graph, the data points form a [blank1]. The vertical intercept (y-intercept at t = 0) represents [blank2].",
          "blanks": {
            "blank1": {
              "correct": "straight line with constant positive slope",
              "options": [
                "straight line with constant positive slope",
                "curved upward parabola",
                "flat horizontal line"
              ]
            },
            "blank2": {
              "correct": "the initial velocity v₀ = +4.0 m/s",
              "options": [
                "the initial velocity v₀ = +4.0 m/s",
        ...
        },
        {
          "stepId": "step_2",
          "type": "data_calculation",
          "title": "Part 2: Calculating Graph Slope (Acceleration)",
          "prompt": "Calculate the slope of the v-t line (acceleration) in m/s² using the coordinate points (0.0 s, 4.0 m/s) and (6.0 s, 16.0 m/s).",
          "inputLabel": "Acceleration (Slope)",
          "unit": "m/s²",
          "targetValue": 2,
          "tolerance": 0.1,
          "formulaHint": "a = Δv / Δt = (v₂ - v₁) / (t₂ - t₁)",
          "hint": "slope = Δv / Δt = (16.0 m/s - 4.0 m/s) / (6.0 s - 0.0 s) = 12.0 m/s / 6.0 s = 2.0 m/s²."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
          "title": "Part 3: Defending v-t Slope Meaning with AI Mentor",
          "prompt": "Discuss your reasoning with the AI Physics Mentor: Explain what would happen to the line if the drone had a negative acceleration instead, and what a horizontal flat line would mean.",
          "openingPrompt": "You found that the slope of the v-t line is +2.0 m/s², which means the drone speeds up by 2.0 m/s every second! What would the line look like if the drone had a negative acceleration of -3.0 m/s²? What if the line were completely flat and horizontal?",
          "minTurns": 1
        }
      ],
      "teacherKey": "Step 1: straight line with constant positive slope, the initial velocity v₀ = +4.0 m/s. Step 2: 2.0 m/s² (12.0 / 6.0). Step 3: Claim: A negative acceleration creates a downward-sloping line, while a flat horizontal line represents constant velocity (zero acceleration). Evidence: Slope on a v-t graph equals acceleration (m = Δv / Δt). When a = -3.0 m/s², the line slants downward from left to right as velocity decreases. When a = 0 m/s², the line has zero slope and remains horizontal. Reasoning: Velocity-time slope directly visualizes the rate of change of velocity; positive slopes mean velocity increases, negative slopes mean velocity decreases, and zero slope means velocity is unchanging."
    },
    "assignments": [
      {
    ...
    "resources": [
      ...
      },
      {
        ...
        "url": "Unit_2/velocity_time_graph_studio/index.html",
        "typeLabel": "Interactive Web Tool",
        "description": "Explore constant acceleration lines, slope readouts, and strobe trails."
      },
      {
        "title": "Dual-Graph Motion Studio",
        "url": "Unit_2/dual_graph_studio/index.html",
  ...
  },
  {
    ...
    "date": "2026-09-24",
    "unit": 2,
    "title": "Differentiated Kinematics Labs: Human Reaction Time Free-Fall Lab (Period 0) & Pull-Back Toy Motion Lab (Periods 1–6)",
    "topic": "Period 0 Honors: Human Neural Reaction Time via Metric Ruler Free-Fall Kinematics (t = √(2d/g)) | Periods 1–6: Hands-On Metric Track Slow-Motion Telemetry & x vs. t Analysis",
    "dok": 3,
    "type": "Hands-On Laboratory / Differentiated Inquiry",
    "semester": 1,
    "isFeatured": true,
    "summary": "Differentiated hands-on laboratory day across physics sections: Period 0 (Honors Physics) investigates human neural reflex timing and free-fall kinematics with the P031 Reaction Time Lab, dropping metric rulers to calculate reaction times from free-fall displacement (d = ½gt² -> t = √(2d/g)), testing visual vs. auditory stimulus and smartphone distractions, and calculating vehicle reaction distance at highway speeds. Periods 1–6 conduct the hands-on Pull-Back Toy Motion Lab, capturing slow-motion video telemetry of pull-back cars across a 1.0 m track at 20 cm increments to plot x vs. t curves and calculate v_avg, v_f, and uniform acceleration.",
    "activity": "Differentiated Laboratory Block: \n• Period 0 Honors: P031 Human Reaction Time & Free-Fall Kinematics Lab — partner metric ruler drop trials measuring reaction displacement (cm), calculating reflex times (ms) via t = √(2d/g), testing visual vs. auditory cues and phone distraction delays, and computing freeway reaction distances (d_react = v₀ · t).\n• Periods 1–6: Graphing Pull-Back Toy Motion Lab — 1.0 m metric track calibration, dual-shot video recording, 5-interval position-time data collection, curve plotting, and calculation verification with the interactive lab companion.",
    "essentialQuestion": "How does measuring an object in free fall (Period 0 ruler drops) or horizontal acceleration from rest (Periods 1–6 pull-back cars) allow us to calculate unknown kinematic quantities like time and acceleration?",
    "standards": [
      "HS-PS2-1",
      "HS-PS2-2"
    ],
    "wicor": {
      "Writing": "Period 0: Documenting calculated reaction times (t = √(2d/g)), comparing dominant vs. non-dominant hands, and explaining distracted driving hazards. Periods 1–6: Documenting calculated velocities (v_avg, v_f, a) with units and describing curved x vs. t graphs.",
      "Inquiry": "Period 0: Testing the effect of auditory vs. visual sensory pathways and smartphone distraction on human neural reflex times. Periods 1–6: Capturing line-crossing timestamps from slow-motion video to analyze constant acceleration.",
    ...
    "bellRinger": {
      "type": "cast_challenge",
      "title": "Finding Distance from Velocity-Time Graph Area",
      "defaultDuration": 4,
      "standards": {
        "dci": "HS-PS2.A: Forces & Motion",
        "sep": "SEP-5: Using Mathematics & Computational Thinking",
      ...
      "phenomenon": {
        "title": "Electric Scout Vehicle Acceleration Run",
        "description": "An electric scout cart starts from rest (v₀ = 0.0 m/s) and accelerates uniformly along a straight track, reaching a top speed of v_f = +10.0 m/s after an elapsed time of t = 4.0 seconds. The distance traveled equals the geometric area under the velocity-time graph.",
        "stimulus": {
          "type": "data_table",
          "title": "Scout Cart 4.0-Second Run Telemetry",
          "headers": [
            "Elapsed Time (t)",
            "Velocity (v)",
            "Geometric Feature on v-t Graph"
          ],
          "rows": [
            {
              "col_0": "0.0 s",
              "col_1": "0.0 m/s",
              "col_2": "Origin point (v₀ = 0, starting from rest)"
            },
            {
              "col_0": "2.0 s",
              "col_1": "+5.0 m/s",
              "col_2": "Halfway timestamp (average speed = 5.0 m/s)"
            },
            {
              "col_0": "4.0 s",
              "col_1": "+10.0 m/s",
              "col_2": "Peak final speed (height of triangle = 10.0 m/s)"
            }
          ]
        }
      },
      "steps": [
        {
          "stepId": "step_1",
          "type": "cloze_dropdown",
          "title": "Part 1: Identifying the Geometric Shape Under the Line",
          "prompt": "Inspect the v-t graph telemetry for the cart accelerating from rest:",
          "text": "When an object speeds up uniformly starting from rest (0 m/s), the shaded region under the line forms a [blank1]. To calculate the distance traveled, we find the area using the formula [blank2].",
          "blanks": {
            "blank1": {
              "correct": "single triangle",
              "options": [
                "single triangle",
        ...
        },
        {
          "stepId": "step_2",
          "type": "data_calculation",
          "title": "Part 2: Calculating Distance from Triangle Area",
          "prompt": "Calculate the total distance traveled in meters from t = 0 to t = 4.0 s by finding the area of the triangle: Area = ½ · base · height (base = 4.0 s, height = 10.0 m/s).",
          "inputLabel": "Distance Traveled (Area)",
          "unit": "m",
          "targetValue": 20,
          "tolerance": 0.5,
          "formulaHint": "Area = ½ · base · height",
          "hint": "Area = ½ · base · height = ½ · (4.0 s) · (10.0 m/s) = 20.0 meters."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
          "title": "Part 3: Area Under the Curve Meaning with AI Mentor",
          "prompt": "Discuss your reasoning with the AI Physics Mentor: Explain why an accelerating object travels only HALF the distance of an object moving at the top speed the entire time, and during which half of the trip it covers more ground.",
          "openingPrompt": "You found that the vehicle travels 20.0 meters (Area = ½ · 4.0 s · 10.0 m/s)! Notice that if the vehicle had traveled at its top speed of 10.0 m/s the entire 4 seconds, it would have covered 40.0 meters (a rectangle: 10 × 4). Why does accelerating from rest cover exactly HALF of that distance? And during which 2 seconds did it travel more ground: the first 2 seconds (0 to 2 s) or the last 2 seconds (2 to 4 s)?",
          "minTurns": 1
        }
      ],
      "teacherKey": "Step 1: single triangle, Area = ½ · base · height. Step 2: 20.0 m (½ · 4.0 · 10.0). Step 3: Claim: The vehicle covers 20.0 m, which is exactly half of the 40.0 m constant-speed rectangle, and it travels three times further during the second half of the time interval (from 2 to 4 s). Evidence: Because speed starts at 0 m/s and increases linearly to 10.0 m/s, the average speed is 5.0 m/s (half of maximum speed). Distance is v_avg · t = 5.0 m/s · 4.0 s = 20.0 m. In the first 2 seconds, it travels only 5.0 m (½ · 2 · 5), while in the last 2 seconds it covers 15.0 m (20 - 5). Reasoning: Geometrically, a triangle with the same base and height has exactly half the area of a rectangle. Physically, an accelerating object spends the early seconds at low velocities and the later seconds at high velocities, so distance accumulates much faster near the end of the run."
    },
    "assignments": [
      {
  ...
  },
  {
    ...
    "bellRinger": {
      "type": "cast_challenge",
      "title": "Two-Stage Stopping Distance Telemetry",
      "defaultDuration": 4,
      "standards": {
        "dci": "HS-PS2.A: Forces & Motion",
        "sep": "SEP-5: Using Mathematics & Computational Thinking",
      ...
      "steps": [
        {
          ...
          "blanks": {
            "blank1": {
              "correct": "Δx₁ = 20.0 m/s · 0.50 s = 10.0 meters",
              "options": [
                "Δx₁ = 20.0 m/s · 0.50 s = 10.0 meters",
                "Δx₁ = 20.0 m/s · 0.50 s = 40.0 meters",
                "Δx₁ = ½(20.0)(0.50)² = 2.5 meters"
              ]
            },
            "blank2": {
              "correct": "zero (speed is constant)",
              "options": [
        ...
        },
        {
          ...
          "prompt": "During braking, the car slows from 20.0 m/s to 0 m/s in 4.0 s. Calculate the braking distance in meters: Δx₂ = ½ · (v₀ + v<sub>f</sub>) · t<sub>brake</sub> = ½ · (20.0 + 0) · 4.0 s.",
          "inputLabel": "Braking Distance",
          "unit": "m",
          "targetValue": 40,
          "tolerance": 0.1,
          "hint": "Δx₂ = ½ · (20.0 m/s) · (4.0 s) = 40.0 meters."
        },
        {
          "stepId": "step_3",
          "type": "ai_reasoning_chat",
    ...
    "resources": [
      ...
      },
      {
        ...
        "url": "Unit_2/dual_graph_studio/index.html",
        "typeLabel": "Interactive Web Tool",
        "description": "Model two-stage constant speed and acceleration graphs."
      }
    ],
    "practice": [
      {
    ...
    "resources": [
      {
        ...
        "status": "planned",
        "actionLabel": "In-Class Resource Notice"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "bellRinger": {
      ...
      "explanation": "The net force is exactly ZERO Newtons! Because the jet travels at a constant velocity (constant speed in a straight line), its acceleration is zero. By Newton's First Law, a = 0 means F<sub>net</sub> = 0. Forward jet engine thrust perfectly equals aerodynamic drag, and wing lift perfectly equals gravitational weight.",
      "defaultDuration": 3
    },
    "links": {
  ...
  },
  {
    ...
    "semester": 1,
    "isFeatured": true,
    "summary": "Empirically verify that acceleration is inversely proportional to mass under constant force, synthesizing the master equation F<sub>net</sub> = m · a.",
    "activity": "Modified Atwood Track Lab (Part 2): Keeping hanging pulling mass constant while systematically stacking mass bars on the cart (0.5 kg, 1.0 kg, 1.5 kg). Plotting a vs m (inverse curve) and a vs 1/m (linear), synthesizing F<sub>net</sub> = m · a.",
  ...
  },
  {
    ...
    "topic": "Friction Forces (F<sub>f</sub> = μ · F<sub>N</sub>), Surface Interfaces, and Energy Dissipation",
    "dok": 2,
    "type": "Lab / Activity",
    "semester": 1,
    "isFeatured": true,
    ...
    "wicor": {
      ...
      "Organization": "Calculating friction coefficients (μ = F<sub>f</sub> / F<sub>N</sub>) across trials in structured data tables.",
    ...
    "assignments": [
      {
        ...
        "submission": "In-Class Handout (Subject to Pacing)",
        "actionLabel": "In-Class Activity Notice",
        "description": "Measure friction forces across varying surface textures and normal forces to calculate μ<sub>s</sub> and μ<sub>k</sub>.",
        "status": "planned"
      }
    ],
    "resources": [
  ...
  },
  {
    ...
    "date": "2026-10-09",
    "unit": 2,
    "title": "Student-Designed Traction Investigation & Highway Curve Safety Specification",
    "topic": "Comparative Empirical Friction Methodology, Systematic Error Reconciliation, and Highway Safety Engineering",
    "dok": 4,
    "type": "Engineering Design / Investigation",
    "semester": 1,
    "isFeatured": true,
    "summary": "Student teams design and execute two competing empirical methodologies to measure static and kinetic friction coefficients, reconcile experimental discrepancies through systematic error analysis, and engineer a formal highway curve safety specification.",
    "activity": "Comparative Traction Protocol & Highway Safety Specification (DOK 4 Extended Investigation): Teams act as highway safety research consultants. Rather than following a step-by-step procedure, teams must: (1) independently formulate and carry out two distinct experimental protocols to measure friction coefficients on road materials (horizontal force sensor drag vs. critical angle of incline slip where μ<sub>s</sub> = tan(theta)), (2) identify and reconcile discrepancies between the methods by analyzing contact temperature, surface wear, and stick-slip chatter, and (3) synthesize empirical friction coefficients with Newton's 2nd Law and kinematics to calculate stopping distance envelopes and specify safe wet-weather speed limits for a banked mountain highway curve.",
    "essentialQuestion": "Why must materials engineers reconcile multiple experimental paradigms and error sources before establishing critical safety specifications for transportation systems?",
    "standards": [
      "HS-PS2-1",
      "HS-ETS1-2"
    ],
    "wicor": {
      "Writing": "Drafting a comprehensive Highway Safety Specification and experimental error reconciliation memo.",
      "Inquiry": "Designing independent experimental protocols to compare static vs kinetic friction without teacher-directed step procedures.",
      "Collaboration": "Consulting engineering teams allocating roles: protocol designer, precision sensor operator, and data integrity auditor.",
      "Organization": "Structuring comparative data tables mapping horizontal drag vs incline slip angles across surface conditions.",
      "Reading": "Interpreting Department of Transportation pavement friction standards and tire safety ratings."
    },
    "bellRinger": {
      "type": "free_response",
      "promptQuestion": "A 1000 kg car brakes with a net friction force of 5000 N. What is the car's deceleration, and how does Newton's 2nd Law (a = F<sub>net</sub> / m) connect to how long it takes the car to stop?",
      "explanation": "a = F<sub>net</sub> / m = -5000 N / 1000 kg = -5.0 m/s². The deceleration produced by the net force determines the rate at which velocity drops to zero (t = Δv / a) and the required stopping distance (d = v₀t + ½at²).",
      "defaultDuration": 3
    },
    "links": {
    ...
    "assignments": [
      {
        "title": "Highway Safety & Traction Engineering Specification Report",
        "typeLabel": "DOK 4 Engineering Report",
        "submission": "In-Class Handout (Subject to Pacing)",
        "actionLabel": "In-Class Activity Notice",
        "description": "Design two competing friction protocols, reconcile systematic errors, and establish wet-weather speed limit specifications.",
        "status": "planned"
      }
    ],
    "resources": [
      {
        "title": "Experimental Friction Methodology & Pavement Design Guide",
        "url": "https://docs.google.com/presentation/d/10-afry9hEiN-b1U_qzE--Z5f7CUKvfde_nuPIWVNJgk/edit?usp=sharing",
        "typeLabel": "Engineering Guide",
        "description": "Comparing drag force sensors vs critical incline slip angles (μ<sub>s</sub> = tan theta) and highway banking equations."
      },
      {
        "title": "Two-Car Kinematic Intercept Simulator",
        "url": "Unit_2/two_car_intercept/index.html",
        "typeLabel": "Simulation Tool",
        "description": "Simulate vehicle stopping distances under varying friction coefficients."
      }
    ],
    "practice": [
      {
        ...
        "url": "Unit_2/two_car_intercept/index.html",
        "typeLabel": "Practice Tool",
        "description": "Test braking deceleration and stopping distance profiles."
      }
    ]
  },
  {
    ...
    "semester": 1,
    "isFeatured": true,
    "summary": "Investigate interaction force pairs: whenever one object exerts a force on a second, the second exerts an equal and opposite force back on the first (F<sub>A on B</sub> = -F<sub>B on A</sub>).",
    ...
    "assignments": [
      {
        ...
        "submission": "In-Class Handout (Subject to Pacing)",
        "actionLabel": "In-Class Activity Notice",
        "description": "Analyze dual force sensor collision data between equal and unequal cart masses to prove F<sub>A on B</sub> = -F<sub>B on A</sub>.",
        "status": "planned"
      }
    ],
    "resources": [
  ...
  },
  {
    ...
    "date": "2026-10-14",
    "unit": 2,
    "title": "Structural Crashworthiness Engineering: Crumple Zone Impulse Optimization",
    "topic": "Iterative Engineering Design: Reducing Impact Force via Deceleration Duration Extension under Physical Constraints",
    "dok": 4,
    "type": "Engineering Design / Lab",
    "semester": 1,
    "isFeatured": true,
    "summary": "Execute a multi-iteration engineering design cycle optimizing vehicle crumple zone structures. Teams prototype and test physical and simulated bumpers to minimize peak impact force (F · Δt = m · Δv) under strict mass and dimension constraints.",
    ...
    "essentialQuestion": "How do automotive engineers manipulate structural deformation and material failure modes to minimize lethal deceleration forces within strict mass and space constraints?",
    "standards": [
      "HS-PS2-1",
      "HS-ETS1-2"
    ],
    "wicor": {
      "Writing": "Documenting iterative design logs, recording structural modifications and telemetry delta readouts.",
      "Inquiry": "Testing material failure geometries (accordion pleats vs honeycomb cells) to maximize energy absorption time.",
      "Collaboration": "Engineering design squads: CAD/structure fabricator, telemetry sensor technician, and systems budget auditor.",
      "Organization": "Managing multi-trial data tables comparing peak impact force (N), collision duration (ms), and structural deformation (cm).",
      "Reading": "Interpreting IIHS automotive crashworthiness ratings, accelerometer curves, and impulse area integrals."
    },
    "bellRinger": {
      "type": "free_response",
      ...
      "explanation": "Crumple zones intentionally lengthen the time (Δt) it takes the passenger cabin to come to a stop. Because F<sub>impact</sub> = m · Δv / Δt, increasing stopping time by a factor of 4 reduces the lethal impact force on passengers by 75%, saving lives.",
      "defaultDuration": 3
    },
    "links": {
    ...
    "assignments": [
      {
        "title": "Operation Safe Heeler Crash Engineering Portfolio",
        "url": "operation-safe-heeler.html",
        "typeLabel": "DOK 4 Engineering Portfolio",
        "submission": "Cloud Auto-Saved ✓",
        "actionLabel": "Launch Engineering Lab",
        "description": "Design and iteratively test crumple zones under mass and depth constraints, optimizing deceleration telemetry."
      }
    ],
    "resources": [
      {
        "title": "Safe Heeler Telemetry & Crash Analytics Platform",
        "url": "operation_safe_heeler_results.html",
        "typeLabel": "Telemetry Analytics",
    ...
    "practice": [
      {
        ...
        "description": "Virtual crash simulator to test material deformation under varying impact speeds."
      }
    ]
  },
  {
    ...
    "date": "2026-10-15",
    "unit": 2,
    "title": "Automotive Safety Symposium & Peer Defense Gallery Walk",
    "topic": "Cross-Disciplinary Kinematics-Dynamics Synthesis, Model Defense, and Peer Technical Review",
    "dok": 4,
    "type": "Symposium / Model Defense",
    "semester": 1,
    "isFeatured": true,
    "summary": "Convene an engineering symposium where student teams present technical design portfolios uniting 1D Kinematics and Newtonian Dynamics, defend their crashworthiness models against peer cross-examination, and audit competing claims.",
    ...
    "essentialQuestion": "How do scientists and engineers critically evaluate and defend complex physical models when public safety depends on the accuracy of the physics?",
    "standards": [
      "HS-PS2-1",
      "HS-ETS1-2"
    ],
    "wicor": {
      "Writing": "Authoring formal technical peer audit critiques with evidence-based justifications.",
      "Inquiry": "Cross-examining peer engineering models to uncover unstated assumptions, calculation flaws, or measurement errors.",
      "Collaboration": "Presenting and defending team technical portfolios under structured peer cross-examination rounds.",
      "Organization": "Assembling multi-domain technical posters uniting kinematic graphs, force vectors, and empirical telemetry.",
      "Reading": "Critically evaluating peer technical posters, data charts, and design trade-off justifications."
    },
    "bellRinger": {
      "type": "free_response",
      ...
      "explanation": "Newton's Second Law: F<sub>net</sub> = m · a! Forces cause acceleration (dynamics), and acceleration changes an object's velocity and position over time (kinematics). It is the master bridge of physics.",
      "defaultDuration": 3
    },
    "links": {
      "Unit 2 Review Slide Deck": "Unit_2/describing-motion-presentation/index.html"
    },
    "assignments": [
      {
        "title": "Technical Symposium Portfolio & Peer Audit Review",
        "typeLabel": "DOK 4 Symposium Defense",
        "submission": "In-Class Handout (Subject to Pacing)",
        "actionLabel": "In-Class Activity Notice",
        "description": "Present technical engineering portfolio, defend kinematics-dynamics models under cross-examination, and submit peer audits.",
        "status": "planned"
      }
    ],
    "resources": [
      {
        "title": "Unit 2 Grand Synthesis & Technical Defense Presentation",
        "url": "Unit_2/describing-motion-presentation/index.html",
        "typeLabel": "Symposium Guide",
        "description": "Comprehensive synthesis unifying 1D Kinematics and Newtonian Dynamics with technical presentation rubrics."
      }
    ],
    "practice": [
      {
        ...
        "url": "operation-safe-heeler.html",
        "typeLabel": "Engineering Sandbox",
        "description": "Review crash impulse curves during symposium prep."
      }
    ]
  },
  {
    ...
    "semester": 1,
    "isFeatured": true,
    "summary": "Full summative evaluation assessing DOK 1-3 mastery across 1D kinematics (x, v, a, graphs, UAM, free fall) and Newtonian dynamics (Inertia, FBDs, F<sub>net</sub> = m · a, Friction, Action-Reaction, and Crash Engineering).",
