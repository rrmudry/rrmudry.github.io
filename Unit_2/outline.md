...
**Guiding Essential Question:** How do kinematic measurements of position, velocity, and acceleration unite with Newtonian forces to explain and predict all motion?
...
### Week 1: Position, Distance, Displacement & Constant Speed
...
*   **Day 2 (2026-09-01): Fantasy Map Quest — Part 2: Realm Cartography & Hazard Design**
    *   *Bell-Ringer:* Distance vs. Net Displacement: If an adventurer travels 15 km north to a temple and 15 km south back home, what is their total distance traveled and net displacement? (Distance = 30 km, Displacement = 0 km).
...
*   **Day 3 (2026-09-02): Fantasy Map Quest — Part 3: Curved Trails, Distance vs. Displacement & Quest Analysis**
    *   *Bell-Ringer:* Speed & Travel Rate: If a traveler walks 40 km through an enchanted forest over 8 days, what is the traveler's average speed in km per day? (`v = d / t = 40 km / 8 days = 5 km/day`).
...
*   **Day 4 (2026-09-03): Fantasy Map Quest — Part 4: Digital Exploration & Vector Simulation**
    *   *Bell-Ringer:* Runner Speed Reasoning: If a runner travels at a steady speed of 2 meters every second, how far will they travel in 5 seconds? Explain your reasoning. (`d = v · t = 2 m/s · 5 s = 10 meters`).
...
*   **Day 5 (2026-09-04): "The Monster's Journey" Constant Velocity Lab & Uniform Motion Graphing**
    *   *Bell-Ringer:* Walking Toy Speed & Trial Averaging (AI Chat): How would you measure the speed of a walking toy, and why is it essential to time multiple runs and calculate an average time instead of relying on a single test?
    ...
    *   *Links:* [Wind-Up Toy Speed Lab](https://rrmudry.github.io/Unit_2/wind_up_toy_lab/index.html), [Distance vs Time App](https://rrmudry.github.io/distance_vs_time_graphing.html), [Motion Curve Drawer](https://rrmudry.github.io/Distance_vs_Time_Drawer.html), [Interactive Presentation](https://rrmudry.github.io/Unit_2/describing-motion-presentation/index.html)
...
*   **Day 16 (2026-09-21): Introducing Acceleration: Velocity Changes & Rate of Change (`a = Δv / Δt`)**
    *   *Decomposed Learning Goals (Low Floor ➔ High Ceiling):*
        1. **Level 1 (Low Floor - Conceptual)**: Vector Signs & The 2x2 Matrix: Distinguish velocity sign (heading: +x vs. -x) from acceleration sign (thrust/force: +a vs. -a). Prove matching signs = speeding up, opposite signs = slowing down, overcoming the misconception that negative acceleration always means slowing down.
        2. **Level 2 (Bridge - Concrete Units)**: The Physical Meaning of Units: Interpret m/s² as (m/s) per second through discrete second-by-second strobe accumulation tables: v(t + 1) = v(t) + a.
        3. **Level 3 (Target Proficiency - GUESS Calculations)**: Rate of Change Problem Solving: Isolate all variables in `a = Δv / Δt`, `Δv = a · Δt`, and `Δt = Δv / a`, computing signed velocity differences `Δv = v<sub>f</sub> - v₀` with double-negative arithmetic.
        4. **Level 4 (High Ceiling - Synthesis)**: Directional Reversals & Hazard Braking: Analyze motion where an object slows to instantaneous rest (v = 0) and reverses direction while acceleration remains continuous, calculating turnaround times `t = -v₀ / a`.
...
*   **Day 17 (2026-09-22): The Kinematic Velocity Equation: Calculating Final Velocity (v<sub>f</sub> = v₀ + at)**
    *   *Bell-Ringer:* Constant Speed Highway Cruise Telemetry (CAST Challenge): An electric vehicle cruises along an interstate at a constant velocity of +25.0 m/s for 16.0 s. Students identify that constant velocity means acceleration is zero (a = 0.0 m/s²), use Δx = v · t to calculate distance traveled (400.0 m), and explain how constant speed creates a straight-line slope on position-time graphs with an AI mentor.
    ...
    *   *Activity:* Kinematic Velocity Calculator: 3-tier scaffolded webapp tackling real-world vehicular kinematics (highway merging, aircraft takeoff runs, and emergency braking). Students drag and match Givens/Unknowns, compute isolating v<sub>f</sub>, v₀, a, and t with Desmos telemetry verification, and submit certified scores.
...
*   **Day 19 (2026-09-24): Differentiated Kinematics Labs: Human Reaction Time Free-Fall Lab (Period 0) & Pull-Back Toy Motion Lab (Periods 1–6)**
...
*   **Day 31 (2026-10-12): Newton's Third Law: Action-Reaction Interaction Pairs**
    ...
    *   *Links:* [Newton's 3rd Law Slides](Unit_2/describing-motion-presentation/index.html), Action-Reaction Collision Lab Sheet *(Planned In-Class)*
...
*   **Day 32 (2026-10-13): Resolving the 3rd Law Paradox & System Boundaries**
    ...
    *   *Links:* System Boundary Diagramming Worksheet *(Planned In-Class)*
...
*   **Day 34 (2026-10-15): Automotive Safety Symposium & Peer Defense Gallery Walk**
    ...
    *   *Links:* Technical Symposium Rubric & Audit Form *(Planned In-Class)*, [Unit 2 Grand Synthesis Slide Deck](Unit_2/describing-motion-presentation/index.html)
