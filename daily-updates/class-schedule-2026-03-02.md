# Class Schedule: Week of March 2, 2026
**Week 4: The Physics of Radiation**
**Essential Question**: How does thermal energy travel through the vacuum of space to heat the Earth?

## Monday, Mar 2
- **Lesson Title**: Reading: Heat Transfer by Radiation
- **WICOR / AVID**:
  - **Reading**: Focused Annotation & Marking the Text.
  - **Writing**: Summary of electromagnetic waves vs. matter-based transfer.
- **Resources**:
  - [Web App Reading Version](Radiation_Lab/reading.html)
  - [Google Doc Reading](https://docs.google.com/document/d/16y1kJZq4Rafpjyqr0EvsMSPGIB4eLmo9IiJBKGKgWXY/edit?usp=sharing)
...
- **Resources**:
  ...
  - [Lab Worksheet](https://docs.google.com/document/d/1GhgcEpqwD06hJCLF0XsDtxKn1F2LjeIhoBKjFEs2G1M/edit?usp=sharing)
...
- **WICOR / AVID**:
  - **Writing**: CER Statement connecting evidence from the week.
  - **Organization**: Data Matrix used to verify claims.
- **Visitor Highlights**:
  - Students will be peer-reviewing their CER arguments for Visitor Day.
- **Resources**:
  - [AI Career Outlook](ai-impact/index.html)
  - [CER Google Doc](https://docs.google.com/document/d/17auQmJ0RMZ8FiMe9m6arPO1T7Mh-AwGfP39jidER6NY/edit?usp=sharing)
