...
> Persistent knowledge base for `rrmudry.github.io` agent development.
> Read relevant patterns BEFORE starting any task. Update patterns AFTER completing work.
...
| [classroom-gradebook-sync](patterns/classroom-gradebook-sync.md) | google-classroom, oauth, firestore, sync, gradebook, batch | 2026-09-12 | Classroom API permission model, multi-assignment batch sync, Rule B (Higher Score Wins), keyword guards, quota optimization |
...
| [modular-vehicle-physics-game](patterns/modular-vehicle-physics-game.md) | drag-racing, kinematics, newton-second-law, modular-assets, rat-rod, telemetry | 2026-09-19 | 1D Newtonian drag racing game with modular SVG parts, traction limits, mystery crates, academic proving grounds, and dual-car telemetry |
| [acceleration-rate-studio](patterns/acceleration-rate-studio.md) | kinematics, acceleration, rate-of-change, vector-signs, ticker-tape, web-audio, firestore | 2026-09-20 | 1D uniform acceleration studio with dual-vector tracking, 2x2 sign matrix, (m/s)/s ticker tape, GUESS telemetry sprint, and pod hazard braking |
