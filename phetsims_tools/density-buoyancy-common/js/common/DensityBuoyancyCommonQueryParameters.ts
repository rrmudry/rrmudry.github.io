...
const DensityBuoyancyCommonQueryParameters = QueryStringMachine.getAll({
  ...
  gEarth: {
    ...
    defaultValue: 10,
    public: true,
    isValidValue: (value: number) => value >= 9 && value <= 10.5
  },
  ...
  // A mix between 0: Full viscosity is applied when any part of a mass is in the fluid, 1: The viscosity effect is
